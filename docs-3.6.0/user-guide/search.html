...
(<img alt="image" src="images/icon_search_24.png" />) in the navigation bar at the top of
...
<ol>
<li>If there are existing collections, click the <img alt="image" src="images/import.png" /> <strong>Import</strong> button at the top right. The Import Collections and Cores dialog displays.</li>
...
<li>
<p>Press <strong>Enter</strong> or click the <img alt="image" src="images/eyeglass.png" />  icon.</p>
</li>
<li>
...
<li>Click <img alt="image" src="images/clear.png" /> to clear the search string.</li>
</ol>
