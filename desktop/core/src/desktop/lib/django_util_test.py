...
def test_reverse_with_get():
  ...
  assert_equal("/desktop/api2/get_user_preferences/foo", reverse_with_get("desktop.api2.user_preferences", kwargs=dict(key="foo")))
  # Arguments for the view as well as GET parameters
  assert_equal("/desktop/api2/get_user_preferences/foo?a=1&b=2",
