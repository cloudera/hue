        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.a = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.I32:
...
class TestManyTypes(object):
    ...
    def __init__(self, a_bool=None, a_byte=None, a_i16=None, a_i32=None, a_i64=None, a_double=None, a_string=None, a_binary=None, a_enum=None, a_struct=None, a_set=None, a_list=None, a_map=None, a_string_with_default="the_default", a_string_list=None,):
        self.a_bool = a_bool
        self.a_byte = a_byte
        self.a_i16 = a_i16
        self.a_i32 = a_i32
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.a_string = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.STRING:
                ...
                if ftype == TType.STRING:
                    self.a_string_with_default = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 15:
                if ftype == TType.LIST:
    ...
    def write(self, oprot):
        ...
        if self.a_string_with_default is not None:
            ...
            oprot.writeString(self.a_string_with_default.encode('utf-8') if sys.version_info[0] == 2 else self.a_string_with_default)
            oprot.writeFieldEnd()
...
TestStruct.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'a', 'UTF8', None, ),  # 1
    (2, TType.I32, 'b', None, None, ),  # 2
)
all_structs.append(TestNesting)
TestNesting.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'nested_struct', [TestStruct, None], None, ),  # 1
    (2, TType.I32, 'b', None, None, ),  # 2
)
all_structs.append(TestManyTypes)
TestManyTypes.thrift_spec = (
    None,  # 0
    ...
    (7, TType.STRING, 'a_string', 'UTF8', None, ),  # 7
    (8, TType.STRING, 'a_binary', 'BINARY', None, ),  # 8
    (9, TType.I32, 'a_enum', None, None, ),  # 9
    (10, TType.STRUCT, 'a_struct', [TestStruct, None], None, ),  # 10
    (11, TType.SET, 'a_set', (TType.I32, None, False), None, ),  # 11
    (12, TType.LIST, 'a_list', (TType.STRUCT, [TestStruct, None], False), None, ),  # 12
    (13, TType.MAP, 'a_map', (TType.I32, None, TType.STRUCT, [TestStruct, None], False), None, ),  # 13
    (14, TType.STRING, 'a_string_with_default', 'UTF8', "the_default", ),  # 14
    (15, TType.LIST, 'a_string_list', (TType.STRING, 'UTF8', False), None, ),  # 15
)
