...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Document2Permission.all'
        db.delete_column(u'desktop_document2permission', 'all')


    def backwards(self, orm):
        # Adding field 'Document2Permission.all'
        db.add_column(u'desktop_document2permission', 'all',
    ...
    models = {
        ...
        u'desktop.document2': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'27e617a2-b8bf-443a-be77-6a630add7b4d'", 'max_length': '36', 'db_index': 'True'}),
