...
def rungunicornserver():
  ...
  options = {
      ...
      'group': None,
      'initgroups': None,
      'keepalive': 120,                       # When Gunicorn is deployed behind a load balancer, it often makes sense to set this to a higher value.
      ...
      'logconfig': None,
      'loglevel': 'info',
      'max_requests': 0,                      # The maximum number of requests a worker will process before restarting. 0 means disable worker restart.
