...
def hue_version():
  ...
  try:
    assert_equal('cdh6.x-SNAPSHOT', _version_from_properties(io.StringIO("""# Autogenerated build properties
...
cloudera.hash=f5fbe90b6a1d0c186b0ddc6e65ce5fc8d24725c8aaaaa""")))
    ...
    assert_false(_version_from_properties(io.StringIO("""# Autogenerated build properties
version=3.9.0-cdh5.9.0-SNAPSHOT git.hash=f5fbe90b6a1d0c186b0ddc6e65ce5fc8d24725c8 cloudera.hash=f5fbe90b6a1d0c186b0ddc6e65ce5fc8d24725c8aaaaa""")))
    ...
    assert_false(_version_from_properties(io.StringIO('')))
  finally:
