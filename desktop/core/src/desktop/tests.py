...
def hue_version():
  ...
  try:
    assert_equal('3.9.0-cdh5.9.3-SNAPSHOT', _version_from_properties(StringIO.StringIO("""# Autogenerated build properties
version=3.9.0-cdh5.9.3-SNAPSHOT
...
version=3.9.0-cdh5.9.3-SNAPSHOT git.hash=f5fbe90b6a1d0c186b0ddc6e65ce5fc8d24725c8 cloudera.hash=f5fbe90b6a1d0c186b0ddc6e65ce5fc8d24725c8aaaaa""")))
