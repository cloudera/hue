...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        if DATABASE.ENGINE.get().endswith('oracle'):
          db.execute("UPDATE DESKTOP_DOCUMENT2 SET SEARCH = SUBSTR(SEARCH, 1, %s)", [DOCUMENT2_SEARCH_MAX_LENGTH])
    ...
    models = {
        ...
        u'desktop.document2': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'19659599-4bc7-40a6-820b-869364381201'", 'max_length': '36', 'db_index': 'True'}),
