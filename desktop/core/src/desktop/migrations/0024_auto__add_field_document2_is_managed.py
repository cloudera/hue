...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Document2.is_managed'
        db.add_column(u'desktop_document2', 'is_managed',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Document2.is_managed'
        db.delete_column(u'desktop_document2', 'is_managed')
    ...
    models = {
        ...
        u'desktop.document2': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'ad75e99c-32a6-4cf1-a564-6ec7374d9312'", 'max_length': '36', 'db_index': 'True'}),
