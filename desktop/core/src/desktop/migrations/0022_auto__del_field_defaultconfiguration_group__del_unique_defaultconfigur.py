...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DefaultConfiguration.group'
        db.delete_column(u'desktop_defaultconfiguration', 'group_id')

        # Adding M2M table for field groups on 'DefaultConfiguration'
        m2m_table_name = 'defaultconfiguration_groups'
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('defaultconfiguration', models.ForeignKey(orm[u'desktop.defaultconfiguration'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['defaultconfiguration_id', 'group_id'])

        # Adding unique constraint on 'DefaultConfiguration', fields ['app', 'is_default', 'user']
        db.create_unique(u'desktop_defaultconfiguration', ['app', 'is_default', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DefaultConfiguration', fields ['app', 'is_default', 'user']
        db.delete_unique(u'desktop_defaultconfiguration', ['app', 'is_default', 'user_id'])

        # Adding field 'DefaultConfiguration.group'
        db.add_column(u'desktop_defaultconfiguration', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field groups on 'DefaultConfiguration'
        db.delete_table('defaultconfiguration_groups')
    ...
    models = {
        ...
        u'desktop.defaultconfiguration': {
            'Meta': {'ordering': "['app', '-is_default', 'user']", 'unique_together': "(('app', 'is_default', 'user'),)", 'object_name': 'DefaultConfiguration'},
        ...
        u'desktop.document2': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'15b84c63-8dab-44c1-900b-659ec11ad5bc'", 'max_length': '36', 'db_index': 'True'}),
