...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='documentpermission',
            name='groups',
            field=models.ManyToManyField(db_index=True, db_table=b'documentpermission_groups', to='useradmin.OrganizationGroup'),
        ),
        migrations.AddField(
            model_name='documentpermission',
            name='users',
        ...
        migrations.AddField(
            model_name='document2permission',
            name='groups',
            field=models.ManyToManyField(db_index=True, db_table=b'documentpermission2_groups', to='useradmin.OrganizationGroup'),
        ),
        migrations.AddField(
            model_name='document2permission',
            name='users',
        ...
        migrations.AddField(
            ...
            name='groups',
            field=models.ManyToManyField(db_index=True, db_table=b'defaultconfiguration_groups', to='useradmin.OrganizationGroup'),
        ),
        migrations.AddField(
            model_name='defaultconfiguration',
            name='user',
