...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroupRelations'
        db.create_table('desktop_grouprelations', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parent', to=orm['auth.Group'])),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='child', to=orm['auth.Group'])),
        ))
        db.send_create_signal('desktop', ['GroupRelations'])


    def backwards(self, orm):

        # Deleting model 'GroupRelations'
        db.delete_table('desktop_grouprelations')
    ...
    models = {
        ...
        'desktop.grouprelations': {
            'Meta': {'object_name': 'GroupRelations'},
            'child': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'child'", 'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parent'", 'to': "orm['auth.Group']"})
        },
