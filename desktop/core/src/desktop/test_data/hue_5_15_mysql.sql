...
--
-- Host: localhost    Database: hueserver3c5c65efdaa94792fc66123d564e874f
-- ------------------------------------------------------
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$12000$O1tjpIoOp0rk$Wv6YQCwVdSLc5cF+B9sdzvaTGBeRyFIrTJOrtaaRbmI=','2018-06-19 08:51:45',1,'admin','','','',0,1,'2018-06-19 08:51:45'),(1100713,'!','2018-06-19 08:52:49',0,'hue','','','',0,0,'2018-06-19 08:52:49');
...
INSERT INTO `axes_accessattempt` VALUES (1,'python-requests/2.15.1','172.26.9.90','admin',1,'*/*','/accounts/login/','2018-06-19 08:51:46','','username=admin\nserver=Local',0);
...
INSERT INTO `axes_accesslog` VALUES (1,'python-requests/2.15.1','172.26.9.90','admin',1,'*/*','/accounts/login/','2018-06-19 08:51:46',NULL);
...
INSERT INTO `beeswax_savedquery` VALUES ('Sample: Top salary',0,0,'2018-06-19 08:52:49',1100713,'{\"query\": {\"email_notify\": false, \"query\": \"SELECT sample_07.description, sample_07.salary\\r\\nFROM\\r\\n  sample_07\\r\\nWHERE\\r\\n( sample_07.salary > 100000)\\r\\nORDER BY sample_07.salary DESC\\r\\nLIMIT 1000\", \"type\": 0, \"is_parameterized\": false, \"database\": \"default\"}, \"functions\": [], \"VERSION\": \"0.4.1\", \"file_resources\": [], \"settings\": []}',1,'Top salary 2007 above $100k',0,0),('Sample: Salary growth',0,0,'2018-06-19 08:52:49',1100713,'{\"query\": {\"email_notify\": false, \"query\": \"SELECT s07.description, s07.salary, s08.salary,\\r\\n  s08.salary - s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN sample_08 s08\\r\\nON ( s07.code = s08.code)\\r\\nWHERE\\r\\n s07.salary < s08.salary\\r\\nORDER BY s08.salary-s07.salary DESC\\r\\nLIMIT 1000\", \"type\": 0, \"is_parameterized\": false, \"database\": \"default\"}, \"functions\": [], \"VERSION\": \"0.4.1\", \"file_resources\": [], \"settings\": []}',2,'Salary growth (sorted) from 2007-08',0,0),('Sample: Job loss',0,0,'2018-06-19 08:52:49',1100713,'{\"query\": {\"email_notify\": false, \"query\": \"SELECT s07.description, s07.total_emp, s08.total_emp, s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN \\r\\n  sample_08 s08\\r\\nON ( s07.code = s08.code )\\r\\nWHERE\\r\\n( s07.total_emp > s08.total_emp\\r\\n AND s07.salary > 100000 )\\r\\nORDER BY s07.salary DESC\\nLIMIT 1000\", \"type\": 0, \"is_parameterized\": false, \"database\": \"default\"}, \"functions\": [], \"VERSION\": \"0.4.1\", \"file_resources\": [], \"settings\": []}',3,'Job loss among the top earners 2007-08',0,0),('Sample: Customers',0,0,'2018-06-19 08:52:49',1100713,'{\"query\": {\"email_notify\": false, \"query\": \"-- Get email survey opt-in values for all customers\\nSELECT\\r\\n  c.id,\\r\\n  c.name,\\r\\n  c.email_preferences.categories.surveys\\r\\nFROM customers c;\\n\\n\\n\\n-- Select customers for a given shipping ZIP Code\\nSELECT\\r\\n  customers.id,\\r\\n  customers.name\\r\\nFROM customers\\r\\nWHERE customers.addresses[\'shipping\'].zip_code = \'76710\';\\n\\n\\n\\n-- Compute total amount per order for all customers\\nSELECT\\r\\n  c.id AS customer_id,\\r\\n  c.name AS customer_name,\\r\\n  ords.order_id AS order_id,\\r\\n  SUM(order_items.price * order_items.qty) AS total_amount\\r\\nFROM\\r\\n  customers c\\r\\nLATERAL VIEW EXPLODE(c.orders) o AS ords\\r\\nLATERAL VIEW EXPLODE(ords.items) i AS order_items\\r\\nGROUP BY c.id, c.name, ords.order_id;\", \"type\": 0, \"is_parameterized\": false, \"database\": \"default\"}, \"functions\": [], \"VERSION\": \"0.4.1\", \"file_resources\": [], \"settings\": []}',4,'Email Survey Opt-Ins, Customers for Shipping ZIP Code, Total Amount per Order',0,0);
...
INSERT INTO `desktop_document` VALUES ('Top salary 2007 above $100k','0',1,'2018-06-19 08:53:01',17,1,1100713,1,'Sample: Top salary'),('Salary growth (sorted) from 2007-08','0',2,'2018-06-19 08:53:01',17,1,1100713,2,'Sample: Salary growth'),('Job loss among the top earners 2007-08','0',3,'2018-06-19 08:53:01',17,1,1100713,3,'Sample: Job loss'),('Email Survey Opt-Ins, Customers for Shipping ZIP Code, Total Amount per Order','0',4,'2018-06-19 08:53:01',17,1,1100713,4,'Sample: Customers'),('','',1,'2018-06-19 08:53:01',54,1,1100713,5,''),('','',2,'2018-06-19 08:53:01',54,1,1100713,6,'.Trash'),('','',3,'2018-06-19 08:53:01',54,1,1100713,7,'examples'),('Email Survey Opt-Ins, Customers for Shipping ZIP Code, Total Amount per Order','',7,'2018-06-19 08:53:01',54,1,1100713,8,'Sample: Customers'),('Job loss among the top earners 2007-08','',6,'2018-06-19 08:53:01',54,1,1100713,9,'Sample: Job loss'),('Salary growth (sorted) from 2007-08','',5,'2018-06-19 08:53:01',54,1,1100713,10,'Sample: Salary growth'),('Top salary 2007 above $100k','',4,'2018-06-19 08:53:01',54,1,1100713,11,'Sample: Top salary');
...
INSERT INTO `desktop_document2` VALUES (1,1100713,'','','c4ddba3a-89e0-43e0-9ee7-1c349bc90219','directory','{}','','2018-06-19 08:52:49',1,0,NULL,NULL,0,0),(2,1100713,'.Trash','','7f7e15e6-460b-4f07-baeb-2aa731dffba1','directory','{}','','2018-06-19 08:52:49',1,0,1,NULL,0,0),(3,1100713,'examples','','689e0240-49be-4057-92c0-51240497dc9e','directory','{}','','2018-06-19 08:52:49',1,0,1,NULL,0,0),(4,1100713,'Sample: Top salary','Top salary 2007 above $100k','4015fd48-1bcf-4e70-963d-7a7773acd8bc','query-hive','{\"showHistory\": true, \"description\": \"Top salary 2007 above $100k\", \"sessions\": [{\"type\": \"hive\", \"properties\": [{\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Files\", \"key\": \"files\", \"help_text\": \"Add one or more files, jars, or archives to the list of resources.\", \"type\": \"hdfs-files\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Functions\", \"key\": \"functions\", \"help_text\": \"Add one or more registered UDFs (requires function name and fully-qualified class name).\", \"type\": \"functions\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Settings\", \"key\": \"settings\", \"help_text\": \"Hive and Hadoop configuration properties.\", \"type\": \"settings\", \"options\": [\"hive.map.aggr\", \"hive.exec.compress.output\", \"hive.exec.parallel\", \"hive.execution.engine\", \"mapreduce.job.queuename\"]}], \"id\": null}], \"onSuccessUrl\": null, \"name\": \"Sample: Top salary\", \"isManaged\": false, \"isSaved\": true, \"skipHistorify\": false, \"selectedSnippet\": \"hive\", \"type\": \"query-hive\", \"pubSubUrl\": null, \"snippets\": [{\"status\": \"ready\", \"wasBatchExecuted\": false, \"name\": \"Sample: Top salary\", \"lastExecuted\": -1, \"variables\": [], \"database\": \"default\", \"statement_raw\": \"SELECT sample_07.description, sample_07.salary\\r\\nFROM\\r\\n  sample_07\\r\\nWHERE\\r\\n( sample_07.salary > 100000)\\r\\nORDER BY sample_07.salary DESC\\r\\nLIMIT 1000\", \"id\": \"919511dd-59fb-4a6d-a4d8-e490adae4ab2\", \"result\": {\"handle\": {}}, \"statement\": \"SELECT sample_07.description, sample_07.salary\\r\\nFROM\\r\\n  sample_07\\r\\nWHERE\\r\\n( sample_07.salary > 100000)\\r\\nORDER BY sample_07.salary DESC\\r\\nLIMIT 1000\", \"type\": \"hive\", \"properties\": {\"files\": [], \"functions\": [], \"settings\": []}}], \"uuid\": \"4015fd48-1bcf-4e70-963d-7a7773acd8bc\"}','','2018-06-19 08:52:49',1,0,3,NULL,0,0),(5,1100713,'Sample: Salary growth','Salary growth (sorted) from 2007-08','3f86eb1f-227f-4851-adfe-09e01d216e6d','query-hive','{\"showHistory\": true, \"description\": \"Salary growth (sorted) from 2007-08\", \"sessions\": [{\"type\": \"hive\", \"properties\": [{\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Files\", \"key\": \"files\", \"help_text\": \"Add one or more files, jars, or archives to the list of resources.\", \"type\": \"hdfs-files\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Functions\", \"key\": \"functions\", \"help_text\": \"Add one or more registered UDFs (requires function name and fully-qualified class name).\", \"type\": \"functions\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Settings\", \"key\": \"settings\", \"help_text\": \"Hive and Hadoop configuration properties.\", \"type\": \"settings\", \"options\": [\"hive.map.aggr\", \"hive.exec.compress.output\", \"hive.exec.parallel\", \"hive.execution.engine\", \"mapreduce.job.queuename\"]}], \"id\": null}], \"onSuccessUrl\": null, \"name\": \"Sample: Salary growth\", \"isManaged\": false, \"isSaved\": true, \"skipHistorify\": false, \"selectedSnippet\": \"hive\", \"type\": \"query-hive\", \"pubSubUrl\": null, \"snippets\": [{\"status\": \"ready\", \"wasBatchExecuted\": false, \"name\": \"Sample: Salary growth\", \"lastExecuted\": -1, \"variables\": [], \"database\": \"default\", \"statement_raw\": \"SELECT s07.description, s07.salary, s08.salary,\\r\\n  s08.salary - s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN sample_08 s08\\r\\nON ( s07.code = s08.code)\\r\\nWHERE\\r\\n s07.salary < s08.salary\\r\\nORDER BY s08.salary-s07.salary DESC\\r\\nLIMIT 1000\", \"id\": \"9b1e6ee6-1b4a-4da5-857e-adb5d036f72f\", \"result\": {\"handle\": {}}, \"statement\": \"SELECT s07.description, s07.salary, s08.salary,\\r\\n  s08.salary - s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN sample_08 s08\\r\\nON ( s07.code = s08.code)\\r\\nWHERE\\r\\n s07.salary < s08.salary\\r\\nORDER BY s08.salary-s07.salary DESC\\r\\nLIMIT 1000\", \"type\": \"hive\", \"properties\": {\"files\": [], \"functions\": [], \"settings\": []}}], \"uuid\": \"3f86eb1f-227f-4851-adfe-09e01d216e6d\"}','','2018-06-19 08:52:49',1,0,3,NULL,0,0),(6,1100713,'Sample: Job loss','Job loss among the top earners 2007-08','fb49aff3-b97f-4307-ac6a-bf97837ed47f','query-hive','{\"showHistory\": true, \"description\": \"Job loss among the top earners 2007-08\", \"sessions\": [{\"type\": \"hive\", \"properties\": [{\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Files\", \"key\": \"files\", \"help_text\": \"Add one or more files, jars, or archives to the list of resources.\", \"type\": \"hdfs-files\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Functions\", \"key\": \"functions\", \"help_text\": \"Add one or more registered UDFs (requires function name and fully-qualified class name).\", \"type\": \"functions\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Settings\", \"key\": \"settings\", \"help_text\": \"Hive and Hadoop configuration properties.\", \"type\": \"settings\", \"options\": [\"hive.map.aggr\", \"hive.exec.compress.output\", \"hive.exec.parallel\", \"hive.execution.engine\", \"mapreduce.job.queuename\"]}], \"id\": null}], \"onSuccessUrl\": null, \"name\": \"Sample: Job loss\", \"isManaged\": false, \"isSaved\": true, \"skipHistorify\": false, \"selectedSnippet\": \"hive\", \"type\": \"query-hive\", \"pubSubUrl\": null, \"snippets\": [{\"status\": \"ready\", \"wasBatchExecuted\": false, \"name\": \"Sample: Job loss\", \"lastExecuted\": -1, \"variables\": [], \"database\": \"default\", \"statement_raw\": \"SELECT s07.description, s07.total_emp, s08.total_emp, s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN \\r\\n  sample_08 s08\\r\\nON ( s07.code = s08.code )\\r\\nWHERE\\r\\n( s07.total_emp > s08.total_emp\\r\\n AND s07.salary > 100000 )\\r\\nORDER BY s07.salary DESC\\nLIMIT 1000\", \"id\": \"6929bd0a-295b-454d-b99a-5892a10cda4e\", \"result\": {\"handle\": {}}, \"statement\": \"SELECT s07.description, s07.total_emp, s08.total_emp, s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN \\r\\n  sample_08 s08\\r\\nON ( s07.code = s08.code )\\r\\nWHERE\\r\\n( s07.total_emp > s08.total_emp\\r\\n AND s07.salary > 100000 )\\r\\nORDER BY s07.salary DESC\\nLIMIT 1000\", \"type\": \"hive\", \"properties\": {\"files\": [], \"functions\": [], \"settings\": []}}], \"uuid\": \"fb49aff3-b97f-4307-ac6a-bf97837ed47f\"}','','2018-06-19 08:52:49',1,0,3,NULL,0,0),(7,1100713,'Sample: Customers','Email Survey Opt-Ins, Customers for Shipping ZIP Code, Total Amount per Order','493e05d8-5cb8-48ad-8367-eecda37d1fad','query-hive','{\"showHistory\": true, \"description\": \"Email Survey Opt-Ins, Customers for Shipping ZIP Code, Total Amount per Order\", \"sessions\": [{\"type\": \"hive\", \"properties\": [{\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Files\", \"key\": \"files\", \"help_text\": \"Add one or more files, jars, or archives to the list of resources.\", \"type\": \"hdfs-files\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Functions\", \"key\": \"functions\", \"help_text\": \"Add one or more registered UDFs (requires function name and fully-qualified class name).\", \"type\": \"functions\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Settings\", \"key\": \"settings\", \"help_text\": \"Hive and Hadoop configuration properties.\", \"type\": \"settings\", \"options\": [\"hive.map.aggr\", \"hive.exec.compress.output\", \"hive.exec.parallel\", \"hive.execution.engine\", \"mapreduce.job.queuename\"]}], \"id\": null}], \"onSuccessUrl\": null, \"name\": \"Sample: Customers\", \"isManaged\": false, \"isSaved\": true, \"skipHistorify\": false, \"selectedSnippet\": \"hive\", \"type\": \"query-hive\", \"pubSubUrl\": null, \"snippets\": [{\"status\": \"ready\", \"wasBatchExecuted\": false, \"name\": \"Sample: Customers\", \"lastExecuted\": -1, \"variables\": [], \"database\": \"default\", \"statement_raw\": \"-- Get email survey opt-in values for all customers\\nSELECT\\r\\n  c.id,\\r\\n  c.name,\\r\\n  c.email_preferences.categories.surveys\\r\\nFROM customers c;\\n\\n\\n\\n-- Select customers for a given shipping ZIP Code\\nSELECT\\r\\n  customers.id,\\r\\n  customers.name\\r\\nFROM customers\\r\\nWHERE customers.addresses[\'shipping\'].zip_code = \'76710\';\\n\\n\\n\\n-- Compute total amount per order for all customers\\nSELECT\\r\\n  c.id AS customer_id,\\r\\n  c.name AS customer_name,\\r\\n  ords.order_id AS order_id,\\r\\n  SUM(order_items.price * order_items.qty) AS total_amount\\r\\nFROM\\r\\n  customers c\\r\\nLATERAL VIEW EXPLODE(c.orders) o AS ords\\r\\nLATERAL VIEW EXPLODE(ords.items) i AS order_items\\r\\nGROUP BY c.id, c.name, ords.order_id;\", \"id\": \"017aff23-f302-4bb7-abee-fb5a6ce4a9a1\", \"result\": {\"handle\": {}}, \"statement\": \"-- Get email survey opt-in values for all customers\\nSELECT\\r\\n  c.id,\\r\\n  c.name,\\r\\n  c.email_preferences.categories.surveys\\r\\nFROM customers c;\\n\\n\\n\\n-- Select customers for a given shipping ZIP Code\\nSELECT\\r\\n  customers.id,\\r\\n  customers.name\\r\\nFROM customers\\r\\nWHERE customers.addresses[\'shipping\'].zip_code = \'76710\';\\n\\n\\n\\n-- Compute total amount per order for all customers\\nSELECT\\r\\n  c.id AS customer_id,\\r\\n  c.name AS customer_name,\\r\\n  ords.order_id AS order_id,\\r\\n  SUM(order_items.price * order_items.qty) AS total_amount\\r\\nFROM\\r\\n  customers c\\r\\nLATERAL VIEW EXPLODE(c.orders) o AS ords\\r\\nLATERAL VIEW EXPLODE(ords.items) i AS order_items\\r\\nGROUP BY c.id, c.name, ords.order_id;\", \"type\": \"hive\", \"properties\": {\"files\": [], \"functions\": [], \"settings\": []}}], \"uuid\": \"493e05d8-5cb8-48ad-8367-eecda37d1fad\"}','','2018-06-19 08:52:49',1,0,3,NULL,0,0);
...
INSERT INTO `django_session` VALUES ('04e1gkvxcm1soaiprud41ja9u5i65tv3','NjhkOWE1NGFmYjFjNTAxYWZjYTgxMzllNzgwMDI4ZDczY2M1Mjk2Njp7Il9hdXRoX3VzZXJfYmFja2VuZCI6ImRlc2t0b3AuYXV0aC5iYWNrZW5kLkFsbG93Rmlyc3RVc2VyRGphbmdvQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOjF9','2018-07-03 08:51:46'),('uqghh8rzx4yq68deby2ckl6mrlrgh35g','ZmUxNWZkYmZkY2JkZDkwYzMyMjU1MDQ4ODNmMDlkMTY3MTYxNzEwNTp7InRlc3Rjb29raWUiOiJ3b3JrZWQifQ==','2018-07-03 08:51:43');
...
INSERT INTO `south_migrationhistory` VALUES (1,'django_extensions','0001_empty','2018-06-19 08:11:07'),(2,'pig','0001_initial','2018-06-19 08:11:07'),(3,'oozie','0001_initial','2018-06-19 08:11:10'),(4,'oozie','0002_auto__add_hive','2018-06-19 08:11:10'),(5,'oozie','0003_auto__add_sqoop','2018-06-19 08:11:10'),(6,'oozie','0004_auto__add_ssh','2018-06-19 08:11:10'),(7,'oozie','0005_auto__add_shell','2018-06-19 08:11:11'),(8,'oozie','0006_auto__chg_field_java_files__chg_field_java_archives__chg_field_sqoop_f','2018-06-19 08:11:11'),(9,'oozie','0007_auto__chg_field_sqoop_script_path','2018-06-19 08:11:11'),(10,'oozie','0008_auto__add_distcp','2018-06-19 08:11:12'),(11,'oozie','0009_auto__add_decision','2018-06-19 08:11:12'),(12,'oozie','0010_auto__add_fs','2018-06-19 08:11:12'),(13,'oozie','0011_auto__add_email','2018-06-19 08:11:12'),(14,'oozie','0012_auto__add_subworkflow__chg_field_email_subject__chg_field_email_body','2018-06-19 08:11:12'),(15,'oozie','0013_auto__add_generic','2018-06-19 08:11:12'),(16,'oozie','0014_auto__add_decisionend','2018-06-19 08:11:12'),(17,'oozie','0015_auto__add_field_dataset_advanced_start_instance__add_field_dataset_ins','2018-06-19 08:11:12'),(18,'oozie','0016_auto__add_field_coordinator_job_properties','2018-06-19 08:11:12'),(19,'oozie','0017_auto__add_bundledcoordinator__add_bundle','2018-06-19 08:11:13'),(20,'oozie','0018_auto__add_field_workflow_managed','2018-06-19 08:11:13'),(21,'oozie','0019_auto__add_field_java_capture_output','2018-06-19 08:11:13'),(22,'oozie','0020_chg_large_varchars_to_textfields','2018-06-19 08:11:13'),(23,'oozie','0021_auto__chg_field_java_args__add_field_job_is_trashed','2018-06-19 08:11:13'),(24,'oozie','0022_auto__chg_field_mapreduce_node_ptr__chg_field_start_node_ptr','2018-06-19 08:11:14'),(25,'oozie','0022_change_examples_path_format','2018-06-19 08:11:14'),(26,'oozie','0023_auto__add_field_node_data__add_field_job_data','2018-06-19 08:11:14'),(27,'oozie','0024_auto__chg_field_subworkflow_sub_workflow','2018-06-19 08:11:14'),(28,'oozie','0025_change_examples_path_format','2018-06-19 08:11:14'),(29,'desktop','0001_initial','2018-06-19 08:11:14'),(30,'desktop','0002_add_groups_and_homedirs','2018-06-19 08:11:14'),(31,'desktop','0003_group_permissions','2018-06-19 08:11:14'),(32,'desktop','0004_grouprelations','2018-06-19 08:11:14'),(33,'desktop','0005_settings','2018-06-19 08:11:14'),(34,'desktop','0006_settings_add_tour','2018-06-19 08:11:14'),(35,'beeswax','0001_initial','2018-06-19 08:11:15'),(36,'beeswax','0002_auto__add_field_queryhistory_notify','2018-06-19 08:11:15'),(37,'beeswax','0003_auto__add_field_queryhistory_server_name__add_field_queryhistory_serve','2018-06-19 08:11:15'),(38,'beeswax','0004_auto__add_session__add_field_queryhistory_server_type__add_field_query','2018-06-19 08:11:16'),(39,'beeswax','0005_auto__add_field_queryhistory_statement_number','2018-06-19 08:11:16'),(40,'beeswax','0006_auto__add_field_session_application','2018-06-19 08:11:16'),(41,'beeswax','0007_auto__add_field_savedquery_is_trashed','2018-06-19 08:11:16'),(42,'beeswax','0008_auto__add_field_queryhistory_query_type','2018-06-19 08:11:16'),(43,'beeswax','0009_auto__add_field_savedquery_is_redacted__add_field_queryhistory_is_reda','2018-06-19 08:11:16'),(44,'desktop','0007_auto__add_documentpermission__add_documenttag__add_document','2018-06-19 08:11:18'),(45,'desktop','0008_documentpermission_m2m_tables','2018-06-19 08:11:18'),(46,'desktop','0009_auto__chg_field_document_name','2018-06-19 08:11:18'),(47,'desktop','0010_auto__add_document2__chg_field_userpreferences_key__chg_field_userpref','2018-06-19 08:11:19'),(48,'desktop','0011_auto__chg_field_document2_uuid','2018-06-19 08:11:19'),(49,'desktop','0012_auto__chg_field_documentpermission_perms','2018-06-19 08:11:19'),(50,'desktop','0013_auto__add_unique_documenttag_owner_tag','2018-06-19 08:11:19'),(51,'desktop','0014_auto__add_unique_document_content_type_object_id','2018-06-19 08:11:20'),(52,'desktop','0015_auto__add_unique_documentpermission_doc_perms','2018-06-19 08:11:20'),(53,'desktop','0016_auto__add_unique_document2_uuid_version_is_history','2018-06-19 08:11:20'),(54,'desktop','0017_auto__add_document2permission__add_unique_document2permission_doc_perm','2018-06-19 08:11:21'),(55,'desktop','0018_auto__add_field_document2_parent_directory','2018-06-19 08:11:21'),(56,'desktop','0019_auto','2018-06-19 08:11:21'),(57,'desktop','0020_auto__del_field_document2permission_all','2018-06-19 08:11:21'),(58,'desktop','0021_auto__add_defaultconfiguration__add_unique_defaultconfiguration_app_is','2018-06-19 08:11:22'),(59,'desktop','0022_auto__del_field_defaultconfiguration_group__del_unique_defaultconfigur','2018-06-19 08:11:23'),(60,'desktop','0023_auto__del_unique_defaultconfiguration_app_is_default_user__add_field_d','2018-06-19 08:11:23'),(61,'desktop','0024_auto__add_field_document2_is_managed','2018-06-19 08:11:23'),(62,'desktop','0025_auto__add_field_document2_is_trashed','2018-06-19 08:11:23'),(63,'desktop','0026_change_is_trashed_default_to_false','2018-06-19 08:11:23'),(64,'desktop','0027_truncate_documents','2018-06-19 08:11:24'),(65,'beeswax','0009_auto__chg_field_queryhistory_server_port','2018-06-19 08:11:25'),(66,'beeswax','0010_merge_database_state','2018-06-19 08:11:25'),(67,'beeswax','0011_auto__chg_field_savedquery_name','2018-06-19 08:11:25'),(68,'beeswax','0012_auto__add_field_queryhistory_extra','2018-06-19 08:11:25'),(69,'beeswax','0013_auto__add_field_session_properties','2018-06-19 08:11:25'),(70,'beeswax','0014_auto__add_field_queryhistory_is_cleared','2018-06-19 08:11:25'),(71,'jobsub','0001_initial','2018-06-19 08:11:26'),(72,'jobsub','0002_auto__add_ooziestreamingaction__add_oozieaction__add_oozieworkflow__ad','2018-06-19 08:11:26'),(73,'jobsub','0003_convertCharFieldtoTextField','2018-06-19 08:11:26'),(74,'jobsub','0004_hue1_to_hue2','2018-06-19 08:11:26'),(75,'jobsub','0005_unify_with_oozie','2018-06-19 08:11:26'),(76,'jobsub','0006_chg_varchars_to_textfields','2018-06-19 08:11:26'),(77,'oozie','0026_set_default_data_values','2018-06-19 08:11:26'),(78,'oozie','0027_auto__chg_field_node_name__chg_field_job_name','2018-06-19 08:11:27'),(79,'search','0001_initial','2018-06-19 08:11:27'),(80,'search','0002_auto__del_core__add_collection','2018-06-19 08:11:28'),(81,'search','0003_auto__add_field_collection_owner','2018-06-19 08:11:28'),(82,'sqoop','0001_initial','2018-06-19 08:11:28'),(83,'useradmin','0001_permissions_and_profiles','2018-06-19 08:11:28'),(84,'useradmin','0002_add_ldap_support','2018-06-19 08:11:29'),(85,'useradmin','0003_remove_metastore_readonly_huepermission','2018-06-19 08:11:29'),(86,'useradmin','0004_add_field_UserProfile_first_login','2018-06-19 08:11:29'),(87,'useradmin','0005_auto__add_field_userprofile_last_activity','2018-06-19 08:11:29'),(88,'useradmin','0006_auto__add_index_userprofile_last_activity','2018-06-19 08:11:29'),(89,'useradmin','0007_remove_s3_access','2018-06-19 08:11:29'),(90,'useradmin','0008_convert_documents','2018-06-19 08:11:29'),(91,'notebook','0001_initial','2018-06-19 08:11:29');
...
INSERT INTO `useradmin_userprofile` VALUES ('/user/admin',1,1,'HUE',0,'2018-06-19 08:52:49');
...
-- Dump completed on 2018-06-19 18:27:57
