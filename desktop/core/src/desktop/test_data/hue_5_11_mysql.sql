...
--
-- Host: localhost    Database: hueserverbd465d98e25c6de7fc9e81b21c507230
-- ------------------------------------------------------
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$12000$VkiKgunGWCzI$RpOC0tatbcx+740QYs8tYiodqfWSl8NZiM6X/CQcxyo=','2018-06-19 08:44:59',1,'admin','','','',0,1,'2018-06-19 08:44:59'),(1100713,'!','2018-06-19 08:46:02',0,'hue','','','',0,0,'2018-06-19 08:46:02');
...
INSERT INTO `axes_accessattempt` VALUES (1,'python-requests/2.15.1','172.31.115.71','admin',1,'*/*','/accounts/login/','2018-06-19 08:45:01','','username=admin\nserver=Local',0);
...
INSERT INTO `axes_accesslog` VALUES (1,'python-requests/2.15.1','172.31.115.71','admin',1,'*/*','/accounts/login/','2018-06-19 08:45:01',NULL);
...
INSERT INTO `beeswax_savedquery` VALUES ('Sample: Top salary',0,0,'2018-06-19 08:46:02',1100713,'{\"query\": {\"email_notify\": false, \"query\": \"SELECT sample_07.description, sample_07.salary\\r\\nFROM\\r\\n  sample_07\\r\\nWHERE\\r\\n( sample_07.salary > 100000)\\r\\nORDER BY sample_07.salary DESC\\r\\nLIMIT 1000\", \"type\": 0, \"is_parameterized\": false, \"database\": \"default\"}, \"functions\": [], \"VERSION\": \"0.4.1\", \"file_resources\": [], \"settings\": []}',1,'Top salary 2007 above $100k',0,0),('Sample: Salary growth',0,0,'2018-06-19 08:46:02',1100713,'{\"query\": {\"email_notify\": false, \"query\": \"SELECT s07.description, s07.salary, s08.salary,\\r\\n  s08.salary - s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN sample_08 s08\\r\\nON ( s07.code = s08.code)\\r\\nWHERE\\r\\n s07.salary < s08.salary\\r\\nORDER BY s08.salary-s07.salary DESC\\r\\nLIMIT 1000\", \"type\": 0, \"is_parameterized\": false, \"database\": \"default\"}, \"functions\": [], \"VERSION\": \"0.4.1\", \"file_resources\": [], \"settings\": []}',2,'Salary growth (sorted) from 2007-08',0,0),('Sample: Job loss',0,0,'2018-06-19 08:46:02',1100713,'{\"query\": {\"email_notify\": false, \"query\": \"SELECT s07.description, s07.total_emp, s08.total_emp, s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN \\r\\n  sample_08 s08\\r\\nON ( s07.code = s08.code )\\r\\nWHERE\\r\\n( s07.total_emp > s08.total_emp\\r\\n AND s07.salary > 100000 )\\r\\nORDER BY s07.salary DESC\\nLIMIT 1000\", \"type\": 0, \"is_parameterized\": false, \"database\": \"default\"}, \"functions\": [], \"VERSION\": \"0.4.1\", \"file_resources\": [], \"settings\": []}',3,'Job loss among the top earners 2007-08',0,0),('Sample: Customers',0,0,'2018-06-19 08:46:02',1100713,'{\"query\": {\"email_notify\": false, \"query\": \"-- Get email survey opt-in values for all customers\\nSELECT\\r\\n  c.id,\\r\\n  c.name,\\r\\n  c.email_preferences.categories.surveys\\r\\nFROM customers c;\\n\\n\\n\\n-- Select customers for a given shipping ZIP Code\\nSELECT\\r\\n  customers.id,\\r\\n  customers.name\\r\\nFROM customers\\r\\nWHERE customers.addresses[\'shipping\'].zip_code = \'76710\';\\n\\n\\n\\n-- Compute total amount per order for all customers\\nSELECT\\r\\n  c.id AS customer_id,\\r\\n  c.name AS customer_name,\\r\\n  ords.order_id AS order_id,\\r\\n  SUM(order_items.price * order_items.qty) AS total_amount\\r\\nFROM\\r\\n  customers c\\r\\nLATERAL VIEW EXPLODE(c.orders) o AS ords\\r\\nLATERAL VIEW EXPLODE(ords.items) i AS order_items\\r\\nGROUP BY c.id, c.name, ords.order_id;\", \"type\": 0, \"is_parameterized\": false, \"database\": \"default\"}, \"functions\": [], \"VERSION\": \"0.4.1\", \"file_resources\": [], \"settings\": []}',4,'Email Survey Opt-Ins, Customers for Shipping ZIP Code, Total Amount per Order',0,0);
...
INSERT INTO `desktop_document` VALUES ('Top salary 2007 above $100k','0',1,'2018-06-19 08:46:14',17,1,1100713,1,'Sample: Top salary'),('Salary growth (sorted) from 2007-08','0',2,'2018-06-19 08:46:14',17,1,1100713,2,'Sample: Salary growth'),('Job loss among the top earners 2007-08','0',3,'2018-06-19 08:46:14',17,1,1100713,3,'Sample: Job loss'),('Email Survey Opt-Ins, Customers for Shipping ZIP Code, Total Amount per Order','0',4,'2018-06-19 08:46:14',17,1,1100713,4,'Sample: Customers'),('','',1,'2018-06-19 08:46:14',54,1,1100713,5,''),('','',2,'2018-06-19 08:46:14',54,1,1100713,6,'.Trash'),('','',3,'2018-06-19 08:46:14',54,1,1100713,7,'examples'),('Email Survey Opt-Ins, Customers for Shipping ZIP Code, Total Amount per Order','',7,'2018-06-19 08:46:14',54,1,1100713,8,'Sample: Customers'),('Job loss among the top earners 2007-08','',6,'2018-06-19 08:46:14',54,1,1100713,9,'Sample: Job loss'),('Salary growth (sorted) from 2007-08','',5,'2018-06-19 08:46:14',54,1,1100713,10,'Sample: Salary growth'),('Top salary 2007 above $100k','',4,'2018-06-19 08:46:14',54,1,1100713,11,'Sample: Top salary');
...
INSERT INTO `desktop_document2` VALUES (1,1100713,'','','cfe243f9-bd39-4517-adb2-c3d28310b6c6','directory','{}','','2018-06-19 08:46:02',1,0,NULL,NULL,0,0),(2,1100713,'.Trash','','50697c91-d299-494d-beef-b6e9225d8e1f','directory','{}','','2018-06-19 08:46:02',1,0,1,NULL,0,0),(3,1100713,'examples','','3f0933f9-abeb-47ff-b737-2bd2058c1735','directory','{}','','2018-06-19 08:46:02',1,0,1,NULL,0,0),(4,1100713,'Sample: Top salary','Top salary 2007 above $100k','b81a08f4-2cd8-475b-8675-75224658c898','query-hive','{\"showHistory\": true, \"uuid\": \"b81a08f4-2cd8-475b-8675-75224658c898\", \"sessions\": [{\"type\": \"hive\", \"properties\": [{\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Files\", \"key\": \"files\", \"help_text\": \"Add one or more files, jars, or archives to the list of resources.\", \"type\": \"hdfs-files\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Functions\", \"key\": \"functions\", \"help_text\": \"Add one or more registered UDFs (requires function name and fully-qualified class name).\", \"type\": \"functions\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Settings\", \"key\": \"settings\", \"help_text\": \"Hive and Hadoop configuration properties.\", \"type\": \"settings\", \"options\": [\"hive.map.aggr\", \"hive.exec.compress.output\", \"hive.exec.parallel\", \"hive.execution.engine\", \"mapreduce.job.queuename\"]}], \"id\": null}], \"onSuccessUrl\": null, \"name\": \"Sample: Top salary\", \"skipHistorify\": false, \"isSaved\": true, \"isTask\": false, \"selectedSnippet\": \"hive\", \"type\": \"query-hive\", \"snippets\": [{\"status\": \"ready\", \"wasBatchExecuted\": false, \"name\": \"Sample: Top salary\", \"database\": \"default\", \"variables\": [], \"statement_raw\": \"SELECT sample_07.description, sample_07.salary\\r\\nFROM\\r\\n  sample_07\\r\\nWHERE\\r\\n( sample_07.salary > 100000)\\r\\nORDER BY sample_07.salary DESC\\r\\nLIMIT 1000\", \"id\": \"9b27baa2-10c2-4bc6-83e0-ff94e4b1c4c8\", \"result\": {\"handle\": {}}, \"statement\": \"SELECT sample_07.description, sample_07.salary\\r\\nFROM\\r\\n  sample_07\\r\\nWHERE\\r\\n( sample_07.salary > 100000)\\r\\nORDER BY sample_07.salary DESC\\r\\nLIMIT 1000\", \"type\": \"hive\", \"properties\": {\"files\": [], \"functions\": [], \"settings\": []}}], \"description\": \"Top salary 2007 above $100k\"}','','2018-06-19 08:46:02',1,0,3,NULL,0,0),(5,1100713,'Sample: Salary growth','Salary growth (sorted) from 2007-08','90aea52e-e0f7-4e5d-a59a-1e81cdee7c2f','query-hive','{\"showHistory\": true, \"uuid\": \"90aea52e-e0f7-4e5d-a59a-1e81cdee7c2f\", \"sessions\": [{\"type\": \"hive\", \"properties\": [{\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Files\", \"key\": \"files\", \"help_text\": \"Add one or more files, jars, or archives to the list of resources.\", \"type\": \"hdfs-files\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Functions\", \"key\": \"functions\", \"help_text\": \"Add one or more registered UDFs (requires function name and fully-qualified class name).\", \"type\": \"functions\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Settings\", \"key\": \"settings\", \"help_text\": \"Hive and Hadoop configuration properties.\", \"type\": \"settings\", \"options\": [\"hive.map.aggr\", \"hive.exec.compress.output\", \"hive.exec.parallel\", \"hive.execution.engine\", \"mapreduce.job.queuename\"]}], \"id\": null}], \"onSuccessUrl\": null, \"name\": \"Sample: Salary growth\", \"skipHistorify\": false, \"isSaved\": true, \"isTask\": false, \"selectedSnippet\": \"hive\", \"type\": \"query-hive\", \"snippets\": [{\"status\": \"ready\", \"wasBatchExecuted\": false, \"name\": \"Sample: Salary growth\", \"database\": \"default\", \"variables\": [], \"statement_raw\": \"SELECT s07.description, s07.salary, s08.salary,\\r\\n  s08.salary - s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN sample_08 s08\\r\\nON ( s07.code = s08.code)\\r\\nWHERE\\r\\n s07.salary < s08.salary\\r\\nORDER BY s08.salary-s07.salary DESC\\r\\nLIMIT 1000\", \"id\": \"48654d51-db98-4e08-a879-340977f846fd\", \"result\": {\"handle\": {}}, \"statement\": \"SELECT s07.description, s07.salary, s08.salary,\\r\\n  s08.salary - s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN sample_08 s08\\r\\nON ( s07.code = s08.code)\\r\\nWHERE\\r\\n s07.salary < s08.salary\\r\\nORDER BY s08.salary-s07.salary DESC\\r\\nLIMIT 1000\", \"type\": \"hive\", \"properties\": {\"files\": [], \"functions\": [], \"settings\": []}}], \"description\": \"Salary growth (sorted) from 2007-08\"}','','2018-06-19 08:46:02',1,0,3,NULL,0,0),(6,1100713,'Sample: Job loss','Job loss among the top earners 2007-08','0dca983d-1674-4911-8fd8-0aead6fb3643','query-hive','{\"showHistory\": true, \"uuid\": \"0dca983d-1674-4911-8fd8-0aead6fb3643\", \"sessions\": [{\"type\": \"hive\", \"properties\": [{\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Files\", \"key\": \"files\", \"help_text\": \"Add one or more files, jars, or archives to the list of resources.\", \"type\": \"hdfs-files\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Functions\", \"key\": \"functions\", \"help_text\": \"Add one or more registered UDFs (requires function name and fully-qualified class name).\", \"type\": \"functions\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Settings\", \"key\": \"settings\", \"help_text\": \"Hive and Hadoop configuration properties.\", \"type\": \"settings\", \"options\": [\"hive.map.aggr\", \"hive.exec.compress.output\", \"hive.exec.parallel\", \"hive.execution.engine\", \"mapreduce.job.queuename\"]}], \"id\": null}], \"onSuccessUrl\": null, \"name\": \"Sample: Job loss\", \"skipHistorify\": false, \"isSaved\": true, \"isTask\": false, \"selectedSnippet\": \"hive\", \"type\": \"query-hive\", \"snippets\": [{\"status\": \"ready\", \"wasBatchExecuted\": false, \"name\": \"Sample: Job loss\", \"database\": \"default\", \"variables\": [], \"statement_raw\": \"SELECT s07.description, s07.total_emp, s08.total_emp, s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN \\r\\n  sample_08 s08\\r\\nON ( s07.code = s08.code )\\r\\nWHERE\\r\\n( s07.total_emp > s08.total_emp\\r\\n AND s07.salary > 100000 )\\r\\nORDER BY s07.salary DESC\\nLIMIT 1000\", \"id\": \"b325065a-3078-4565-a92b-9baf7bec50f6\", \"result\": {\"handle\": {}}, \"statement\": \"SELECT s07.description, s07.total_emp, s08.total_emp, s07.salary\\r\\nFROM\\r\\n  sample_07 s07 JOIN \\r\\n  sample_08 s08\\r\\nON ( s07.code = s08.code )\\r\\nWHERE\\r\\n( s07.total_emp > s08.total_emp\\r\\n AND s07.salary > 100000 )\\r\\nORDER BY s07.salary DESC\\nLIMIT 1000\", \"type\": \"hive\", \"properties\": {\"files\": [], \"functions\": [], \"settings\": []}}], \"description\": \"Job loss among the top earners 2007-08\"}','','2018-06-19 08:46:02',1,0,3,NULL,0,0),(7,1100713,'Sample: Customers','Email Survey Opt-Ins, Customers for Shipping ZIP Code, Total Amount per Order','62da5f90-5ea9-4225-90d7-bb5014a9d37e','query-hive','{\"showHistory\": true, \"uuid\": \"62da5f90-5ea9-4225-90d7-bb5014a9d37e\", \"sessions\": [{\"type\": \"hive\", \"properties\": [{\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Files\", \"key\": \"files\", \"help_text\": \"Add one or more files, jars, or archives to the list of resources.\", \"type\": \"hdfs-files\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Functions\", \"key\": \"functions\", \"help_text\": \"Add one or more registered UDFs (requires function name and fully-qualified class name).\", \"type\": \"functions\"}, {\"multiple\": true, \"defaultValue\": [], \"value\": [], \"nice_name\": \"Settings\", \"key\": \"settings\", \"help_text\": \"Hive and Hadoop configuration properties.\", \"type\": \"settings\", \"options\": [\"hive.map.aggr\", \"hive.exec.compress.output\", \"hive.exec.parallel\", \"hive.execution.engine\", \"mapreduce.job.queuename\"]}], \"id\": null}], \"onSuccessUrl\": null, \"name\": \"Sample: Customers\", \"skipHistorify\": false, \"isSaved\": true, \"isTask\": false, \"selectedSnippet\": \"hive\", \"type\": \"query-hive\", \"snippets\": [{\"status\": \"ready\", \"wasBatchExecuted\": false, \"name\": \"Sample: Customers\", \"database\": \"default\", \"variables\": [], \"statement_raw\": \"-- Get email survey opt-in values for all customers\\nSELECT\\r\\n  c.id,\\r\\n  c.name,\\r\\n  c.email_preferences.categories.surveys\\r\\nFROM customers c;\\n\\n\\n\\n-- Select customers for a given shipping ZIP Code\\nSELECT\\r\\n  customers.id,\\r\\n  customers.name\\r\\nFROM customers\\r\\nWHERE customers.addresses[\'shipping\'].zip_code = \'76710\';\\n\\n\\n\\n-- Compute total amount per order for all customers\\nSELECT\\r\\n  c.id AS customer_id,\\r\\n  c.name AS customer_name,\\r\\n  ords.order_id AS order_id,\\r\\n  SUM(order_items.price * order_items.qty) AS total_amount\\r\\nFROM\\r\\n  customers c\\r\\nLATERAL VIEW EXPLODE(c.orders) o AS ords\\r\\nLATERAL VIEW EXPLODE(ords.items) i AS order_items\\r\\nGROUP BY c.id, c.name, ords.order_id;\", \"id\": \"f38cdf5b-891f-4cad-8db1-44a95f5dba95\", \"result\": {\"handle\": {}}, \"statement\": \"-- Get email survey opt-in values for all customers\\nSELECT\\r\\n  c.id,\\r\\n  c.name,\\r\\n  c.email_preferences.categories.surveys\\r\\nFROM customers c;\\n\\n\\n\\n-- Select customers for a given shipping ZIP Code\\nSELECT\\r\\n  customers.id,\\r\\n  customers.name\\r\\nFROM customers\\r\\nWHERE customers.addresses[\'shipping\'].zip_code = \'76710\';\\n\\n\\n\\n-- Compute total amount per order for all customers\\nSELECT\\r\\n  c.id AS customer_id,\\r\\n  c.name AS customer_name,\\r\\n  ords.order_id AS order_id,\\r\\n  SUM(order_items.price * order_items.qty) AS total_amount\\r\\nFROM\\r\\n  customers c\\r\\nLATERAL VIEW EXPLODE(c.orders) o AS ords\\r\\nLATERAL VIEW EXPLODE(ords.items) i AS order_items\\r\\nGROUP BY c.id, c.name, ords.order_id;\", \"type\": \"hive\", \"properties\": {\"files\": [], \"functions\": [], \"settings\": []}}], \"description\": \"Email Survey Opt-Ins, Customers for Shipping ZIP Code, Total Amount per Order\"}','','2018-06-19 08:46:02',1,0,3,NULL,0,0);
...
INSERT INTO `django_session` VALUES ('bo8r6lj81q29402fzs4fa3kg1eftur8n','MTJhMTE5OWQwMGVjYjNhZWU2N2ZlNGEwOTYyMzk1NjJiOWQxMGZlNzp7InRlc3Rjb29raWUiOiJ3b3JrZWQifQ==','2018-07-03 08:44:57'),('mmf4xjc55noyq37jduizbtcp9706gcm6','ZjI1NjAwYmY2NjRmNjM1ZmM4NGJhNzBjNDA0YjBiZjYwMTZlZTgzYjp7Il9hdXRoX3VzZXJfYmFja2VuZCI6ImRlc2t0b3AuYXV0aC5iYWNrZW5kLkFsbG93Rmlyc3RVc2VyRGphbmdvQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOjF9','2018-07-03 08:45:01');
...
INSERT INTO `south_migrationhistory` VALUES (1,'django_extensions','0001_empty','2018-06-19 08:12:02'),(2,'pig','0001_initial','2018-06-19 08:12:02'),(3,'oozie','0001_initial','2018-06-19 08:12:04'),(4,'oozie','0002_auto__add_hive','2018-06-19 08:12:04'),(5,'oozie','0003_auto__add_sqoop','2018-06-19 08:12:04'),(6,'oozie','0004_auto__add_ssh','2018-06-19 08:12:04'),(7,'oozie','0005_auto__add_shell','2018-06-19 08:12:04'),(8,'oozie','0006_auto__chg_field_java_files__chg_field_java_archives__chg_field_sqoop_f','2018-06-19 08:12:04'),(9,'oozie','0007_auto__chg_field_sqoop_script_path','2018-06-19 08:12:05'),(10,'oozie','0008_auto__add_distcp','2018-06-19 08:12:05'),(11,'oozie','0009_auto__add_decision','2018-06-19 08:12:05'),(12,'oozie','0010_auto__add_fs','2018-06-19 08:12:05'),(13,'oozie','0011_auto__add_email','2018-06-19 08:12:05'),(14,'oozie','0012_auto__add_subworkflow__chg_field_email_subject__chg_field_email_body','2018-06-19 08:12:05'),(15,'oozie','0013_auto__add_generic','2018-06-19 08:12:05'),(16,'oozie','0014_auto__add_decisionend','2018-06-19 08:12:05'),(17,'oozie','0015_auto__add_field_dataset_advanced_start_instance__add_field_dataset_ins','2018-06-19 08:12:06'),(18,'oozie','0016_auto__add_field_coordinator_job_properties','2018-06-19 08:12:06'),(19,'oozie','0017_auto__add_bundledcoordinator__add_bundle','2018-06-19 08:12:06'),(20,'oozie','0018_auto__add_field_workflow_managed','2018-06-19 08:12:06'),(21,'oozie','0019_auto__add_field_java_capture_output','2018-06-19 08:12:06'),(22,'oozie','0020_chg_large_varchars_to_textfields','2018-06-19 08:12:06'),(23,'oozie','0021_auto__chg_field_java_args__add_field_job_is_trashed','2018-06-19 08:12:07'),(24,'oozie','0022_auto__chg_field_mapreduce_node_ptr__chg_field_start_node_ptr','2018-06-19 08:12:07'),(25,'oozie','0022_change_examples_path_format','2018-06-19 08:12:07'),(26,'oozie','0023_auto__add_field_node_data__add_field_job_data','2018-06-19 08:12:07'),(27,'oozie','0024_auto__chg_field_subworkflow_sub_workflow','2018-06-19 08:12:07'),(28,'oozie','0025_change_examples_path_format','2018-06-19 08:12:07'),(29,'desktop','0001_initial','2018-06-19 08:12:08'),(30,'desktop','0002_add_groups_and_homedirs','2018-06-19 08:12:08'),(31,'desktop','0003_group_permissions','2018-06-19 08:12:08'),(32,'desktop','0004_grouprelations','2018-06-19 08:12:08'),(33,'desktop','0005_settings','2018-06-19 08:12:08'),(34,'desktop','0006_settings_add_tour','2018-06-19 08:12:08'),(35,'beeswax','0001_initial','2018-06-19 08:12:08'),(36,'beeswax','0002_auto__add_field_queryhistory_notify','2018-06-19 08:12:08'),(37,'beeswax','0003_auto__add_field_queryhistory_server_name__add_field_queryhistory_serve','2018-06-19 08:12:09'),(38,'beeswax','0004_auto__add_session__add_field_queryhistory_server_type__add_field_query','2018-06-19 08:12:09'),(39,'beeswax','0005_auto__add_field_queryhistory_statement_number','2018-06-19 08:12:09'),(40,'beeswax','0006_auto__add_field_session_application','2018-06-19 08:12:09'),(41,'beeswax','0007_auto__add_field_savedquery_is_trashed','2018-06-19 08:12:09'),(42,'beeswax','0008_auto__add_field_queryhistory_query_type','2018-06-19 08:12:09'),(43,'beeswax','0009_auto__add_field_savedquery_is_redacted__add_field_queryhistory_is_reda','2018-06-19 08:12:10'),(44,'desktop','0007_auto__add_documentpermission__add_documenttag__add_document','2018-06-19 08:12:11'),(45,'desktop','0008_documentpermission_m2m_tables','2018-06-19 08:12:11'),(46,'desktop','0009_auto__chg_field_document_name','2018-06-19 08:12:11'),(47,'desktop','0010_auto__add_document2__chg_field_userpreferences_key__chg_field_userpref','2018-06-19 08:12:12'),(48,'desktop','0011_auto__chg_field_document2_uuid','2018-06-19 08:12:12'),(49,'desktop','0012_auto__chg_field_documentpermission_perms','2018-06-19 08:12:12'),(50,'desktop','0013_auto__add_unique_documenttag_owner_tag','2018-06-19 08:12:12'),(51,'desktop','0014_auto__add_unique_document_content_type_object_id','2018-06-19 08:12:12'),(52,'desktop','0015_auto__add_unique_documentpermission_doc_perms','2018-06-19 08:12:12'),(53,'desktop','0016_auto__add_unique_document2_uuid_version_is_history','2018-06-19 08:12:12'),(54,'desktop','0017_auto__add_document2permission__add_unique_document2permission_doc_perm','2018-06-19 08:12:13'),(55,'desktop','0018_auto__add_field_document2_parent_directory','2018-06-19 08:12:13'),(56,'desktop','0019_auto','2018-06-19 08:12:13'),(57,'desktop','0020_auto__del_field_document2permission_all','2018-06-19 08:12:13'),(58,'desktop','0021_auto__add_defaultconfiguration__add_unique_defaultconfiguration_app_is','2018-06-19 08:12:14'),(59,'desktop','0022_auto__del_field_defaultconfiguration_group__del_unique_defaultconfigur','2018-06-19 08:12:14'),(60,'desktop','0023_auto__del_unique_defaultconfiguration_app_is_default_user__add_field_d','2018-06-19 08:12:14'),(61,'desktop','0024_auto__add_field_document2_is_managed','2018-06-19 08:12:14'),(62,'desktop','0025_auto__add_field_document2_is_trashed','2018-06-19 08:12:15'),(63,'desktop','0026_change_is_trashed_default_to_false','2018-06-19 08:12:15'),(64,'beeswax','0009_auto__chg_field_queryhistory_server_port','2018-06-19 08:12:15'),(65,'beeswax','0010_merge_database_state','2018-06-19 08:12:15'),(66,'beeswax','0011_auto__chg_field_savedquery_name','2018-06-19 08:12:16'),(67,'beeswax','0012_auto__add_field_queryhistory_extra','2018-06-19 08:12:16'),(68,'beeswax','0013_auto__add_field_session_properties','2018-06-19 08:12:16'),(69,'beeswax','0014_auto__add_field_queryhistory_is_cleared','2018-06-19 08:12:16'),(70,'jobsub','0001_initial','2018-06-19 08:12:16'),(71,'jobsub','0002_auto__add_ooziestreamingaction__add_oozieaction__add_oozieworkflow__ad','2018-06-19 08:12:17'),(72,'jobsub','0003_convertCharFieldtoTextField','2018-06-19 08:12:17'),(73,'jobsub','0004_hue1_to_hue2','2018-06-19 08:12:17'),(74,'jobsub','0005_unify_with_oozie','2018-06-19 08:12:17'),(75,'jobsub','0006_chg_varchars_to_textfields','2018-06-19 08:12:17'),(76,'oozie','0026_set_default_data_values','2018-06-19 08:12:18'),(77,'oozie','0027_auto__chg_field_node_name__chg_field_job_name','2018-06-19 08:12:18'),(78,'search','0001_initial','2018-06-19 08:12:19'),(79,'search','0002_auto__del_core__add_collection','2018-06-19 08:12:19'),(80,'search','0003_auto__add_field_collection_owner','2018-06-19 08:12:19'),(81,'sqoop','0001_initial','2018-06-19 08:12:19'),(82,'useradmin','0001_permissions_and_profiles','2018-06-19 08:12:20'),(83,'useradmin','0002_add_ldap_support','2018-06-19 08:12:20'),(84,'useradmin','0003_remove_metastore_readonly_huepermission','2018-06-19 08:12:20'),(85,'useradmin','0004_add_field_UserProfile_first_login','2018-06-19 08:12:20'),(86,'useradmin','0005_auto__add_field_userprofile_last_activity','2018-06-19 08:12:20'),(87,'useradmin','0006_auto__add_index_userprofile_last_activity','2018-06-19 08:12:20'),(88,'useradmin','0007_remove_s3_access','2018-06-19 08:12:20'),(89,'notebook','0001_initial','2018-06-19 08:12:20');
...
INSERT INTO `useradmin_userprofile` VALUES ('/user/admin',1,1,'HUE',0,'2018-06-19 08:46:02');
...
-- Dump completed on 2018-06-19 18:12:02
