...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'desktop_defaultconfiguration', (
            ...
            ('app', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
            ('properties', self.gf('django.db.models.fields.TextField')(default='{}')),
            ('is_default', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal(u'desktop', ['DefaultConfiguration'])

        # Adding unique constraint on 'DefaultConfiguration', fields ['app', 'is_default', 'group', 'user']
        db.create_unique(u'desktop_defaultconfiguration', ['app', 'is_default', 'group_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DefaultConfiguration', fields ['app', 'is_default', 'group', 'user']
        db.delete_unique(u'desktop_defaultconfiguration', ['app', 'is_default', 'group_id', 'user_id'])

        # Deleting model 'DefaultConfiguration'
        db.delete_table(u'desktop_defaultconfiguration')
    ...
    models = {
        ...
        u'desktop.defaultconfiguration': {
            'Meta': {'unique_together': "(('app', 'is_default', 'group', 'user'),)", 'object_name': 'DefaultConfiguration'},
            'app': ('django.db.models.fields.CharField', [], {'max_length': '32', 'db_index': 'True'}),
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Group']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_default': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'db_index': 'True'}),
        ...
        u'desktop.document2': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7000816b-2fcd-4f9c-8664-c87241a386f5'", 'max_length': '36', 'db_index': 'True'}),
