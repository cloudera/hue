  ...
  <script type="text/html" id="doc-browser-template">
    ...
    <div id="deleteEntriesModal" data-keyboard="true" class="modal hide fade" tabindex="-1">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" data-bind="click: function() { if (isTrash() || isTrashed() || (sharedWithMeSelected() && superuser)) { removeDocuments(true) } else { moveToTrash() } }" class="btn btn-danger" value="${_('Yes')}"/>
        <!-- /ko -->
      </div>
      <!-- /ko -->
    </div>
