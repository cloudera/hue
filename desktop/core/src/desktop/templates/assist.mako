  ...
  <script type="text/html" id="assist-document-header-actions">
    <div class="assist-db-header-actions">
      ...
      <span class="dropdown new-document-drop-down">
       ...
       <a class="inactive-action dropdown-toggle" data-toggle="dropdown" data-bind="dropdown : $parent.newDocDropDownVisible" href="javascript:void(0);">
            <i class="pointer fa fa-plus" title="${ _('New document') }"></i>
          </a>
       <ul class="dropdown-menu less-padding document-types" style="margin-top:30px; margin-left:300px; width: 175px;position: relative;" role="menu">
           % if 'beeswax' in apps:
             <li>
     ...
     ko.bindingHandlers.dropdown = {
      init: function (element, valueAccessor) {
          ...
          $(element).on('click', function (event) {
            ...
            if(!previousValue)
              $(element).dropdown();
          });//depending on whether "value" or true or false
      }
     };
      ...
      function AssistDocumentsPanel (options) {
        ...
        self.newDocDropDownVisible = ko.observable(false);
