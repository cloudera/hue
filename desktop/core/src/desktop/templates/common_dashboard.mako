...
<%def name="import_bindings()">
  ...
  <script type="text/javascript">
    KO_DATERANGEPICKER_LABELS = {
      ...
      CUSTOM_POPOVER_CONTENT: "${_('Start')}: NOW-5DAYS/DAY<br/>${_('End')}: NOW/DAY<br/>${_('Interval')}: +1HOURS<br/><a href='http://lucene.apache.org/solr/4_10_2/solr-core/org/apache/solr/util/DateMathParser.html' target='_blank'>${_('Read more...')}</a>"
    };
  </script>
