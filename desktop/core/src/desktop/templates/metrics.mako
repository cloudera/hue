...
<div id="metricsComponent" class="container-fluid">
  <div class="card card-small margin-top-10">
    ...
    <div class="margin-top-10">
      <input type="text" data-bind="clearable: metricsFilter, valueUpdate: 'afterkeydown'" class="input-xlarge pull-right margin-bottom-10" placeholder="${_('Filter metrics...')}">
