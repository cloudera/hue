  ...
  <div class="modal-body" style="overflow: visible; height: 240px">
    ...
    <div style="margin-top: 20px">
      <div class="input-append">
        ...
        <input id="userSearchAutocomp"
              placeholder="test"
              type="text"
              data-bind="customAutocomplete: {
                  source: source,
                  ...
                  showSpinner: true,
                  classPrefix: 'hue-',
                  onEnter: handleTypeaheadSelection,
                  appendTo: 'menu'
              },
              clearable: { value: searchInput },
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu pull-right">
            <li><a data-bind="clickWithArgs: { handler: changeDocumentSharePerm, params: 'read' }" href="javascript:void(0)">${ _('Read') }</a></li>
            <li><a data-bind="clickWithArgs: { handler: changeDocumentSharePerm, params: 'write' }" href="javascript:void(0)">${ _('Read and Modify') }</a></li>
          </ul>
        </div>
      </div>
    </div>
