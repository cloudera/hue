    ...
    <div class="row-fluid">
      <div class="span6">
        ...
        <ul class="unstyled airy" data-bind="foreach: selectedDoc().perms.read.users">
          <li><span class="badge badge-info badge-left"><i class="fa fa-user"></i> <span data-bind="text: prettifyUsername(id), css:{'notpretty': prettifyUsername(id) == ''}, attr:{'data-id': id}"></span></span><span class="badge badge-right trash-share" data-bind="click: removeUserReadShare"> <i class="fa fa-times"></i></span></li>
        </ul>
      ...
      <div class="span6">
        ...
        <ul class="unstyled airy" data-bind="foreach: selectedDoc().perms.write.users">
          <li><span class="badge badge-info badge-left"><i class="fa fa-user"></i> <span data-bind="text: prettifyUsername(id), css:{'notpretty': prettifyUsername(id) == ''}, attr:{'data-id': id}"></span></span><span class="badge badge-right trash-share" data-bind="click: removeUserWriteShare"> <i class="fa fa-times"></i></span></li>
        </ul>
