...
const deleteWarning =  (keyword: string) => `SQL statements starting with ${keyword} are not considered safe to execute since 
...
in the editor.`;
const alterWarning = (keyword: string) => `SQL statements starting with ${keyword} are not considered safe to execute since 
they modify data. To prevent accidental loss of data as a result of interacting with the AI 
assistant you need to confirm that you understand what this query does before you execute it 
in the editor.`;
const defaultKeywordWarning = (keyword: string) => `SQL statements starting with ${keyword} are not considered safe 
