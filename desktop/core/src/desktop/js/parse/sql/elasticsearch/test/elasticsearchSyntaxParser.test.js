...
import elasticsearchSyntaxParser from '../elasticsearchSyntaxParser';

describe('elasticsearchSyntaxParser.js', () => {
  const expectedToStrings = function (expected) {
    return expected.map(ex => ex.text);
  };

  it('should not find errors for ""', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('', '');

    expect(result).toBeFalsy();
  });

  it('should report incomplete statement for "SEL"', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('SEL', '');

    expect(result.incompleteStatement).toBeTruthy();
  });

  it('should report incomplete statement for "SELECT"', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('SELECT', '');
  ...
  it('should not report incomplete statement for "SELECT * FROM tbl"', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('SELECT * FROM tbl', '');

    expect(result.incompleteStatement).toBeFalsy();
  });

  it('should not report incomplete statement for "SELECT * FROM tbl LIMIT 1"', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('SELECT * FROM tbl LIMIT 1', '');

    expect(result.incompleteStatement).toBeFalsy();
  });

  it('should report incomplete statement for "SELECT * FROM tbl LIMIT "', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('SELECT * FROM tbl LIMIT ', '');

    expect(result.incompleteStatement).toBeTruthy();
  });

  it('should report incomplete statement for "SELECT * FROM tbl GROUP"', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('SELECT * FROM tbl GROUP', '');
  ...
  it('should not report incomplete statement for "SELECT * FR"', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('SELECT * FR', '');

    expect(result.incompleteStatement).toBeTruthy();
  });

  it('should find errors for "SLELECT "', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('SLELECT ', '');
  ...
  it('should find errors for "alter tabel "', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('alter tabel ', '');
  ...
  it('should find errors for "select *  form "', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('select *  form ', '');
  ...
  it('should find errors for "select asdf wer qwer qewr   qwer"', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('select asdf wer qwer qewr   qwer', '');
  ...
  it('should suggest expected that the statement should end for "use somedb extrastuff "', () => {
    const result = elasticsearchSyntaxParser.parseSyntax('use somedb extrastuff  ', '');
