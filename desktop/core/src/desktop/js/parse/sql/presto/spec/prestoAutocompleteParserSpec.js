...
describe('prestoAutocompleteParser.js', () => {
  ...
  describe('identifierChain expansion', () => {
    it('should expand 01', () => {
      ...
      const result = prestoAutocompleteParser.expandLateralViews(lateralViews, identifierChain);
    ...
    it('should expand 03', () => {
      ...
      const result = prestoAutocompleteParser.expandLateralViews([], identifierChain);
