...
const TEMPLATE = `
  <div class="btn-group pull-right">
    <!-- ko if: window.IS_K8S_ONLY -->
      <a class="btn btn-flat" title="${I18n(
        'Query browser'
      )}" data-bind="style: { paddingRight: '4px' }", hueLink: '/jobbrowser#!queries', click: function() { huePubSub.publish('show.jobs.panel', {interface: 'queries'}); huePubSub.publish('hide.jobs.panel'); }">
    ...
    <!-- ko ifnot: window.IS_K8S_ONLY -->
      <a class="btn btn-flat" title="${I18n(
        'Job browser'
      )}" data-bind="style: { paddingRight: '4px' }", hueLink: '/jobbrowser#!jobs', click: function() { huePubSub.publish('hide.jobs.panel'); }">
