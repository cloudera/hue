...
const TEMPLATE = `
  <div class="inline-autocomp-container">
    <div>
      <!-- ko if: showMagnify -->
        <!-- ko ifnot: spin -->
        <i data-bind="style: { top: '6px' }" class="inline-autocomp-magnify-icon fa fa-fw fa-search"></i>
        <!-- /ko -->
        <!-- ko if: spin -->
  ...
  <div class="dropdown-menu" data-bind="style: { overflowY: 'auto' }, visible: facetSuggestions().length > 0">  
