...
const TEMPLATE = `
  ...
  <script type="text/html" id="assist-document-header-actions">
    <div class="assist-db-header-actions">
      ...
      <a class="inactive-action" href="javascript:void(0)" data-bind="click: function () { huePubSub.publish('${ REFRESH_DOC_ASSIST_EVENT }'); }"><i class="pointer fa fa-refresh" data-testid = "sql-assist-refresh" data-bind="css: { 'fa-spin blue' : loading }" title="${I18n(
        'Manual refresh'
      )}"></i></a>
    </div>
  </script>
