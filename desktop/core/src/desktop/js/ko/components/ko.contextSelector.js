...
const TEMPLATE = `
  ...
  <div class="inline-block" style="display: none;" data-bind="visible: !loadingContext()">
    ...
    <div data-bind="component: { name: 'hue-drop-down', params: { dataTestId: 'database-selection-dropdown', titleName: 'Database', value: database, entries: availableDatabases, foreachVisible: true, searchable: true, linkTitle: '${I18n(
      'Active database'
    )}' } }" style="display: inline-block"></div>
    <!-- /ko -->
    <!-- ko if: availableDatabases().length === 0  && !hideDatabases -->
