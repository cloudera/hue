...
describe('MetricsComponent', () => {
  ...
  //   // Select the option for 'users' by clicking on it
  //   const optionUsers = screen.getByText('users');
  //   fireEvent.click(optionUsers);
  
  //   // Wait for the UI to update
  //   await waitFor(() => {
  //     // Assert that only the table for the selected metric ('users') is displayed
