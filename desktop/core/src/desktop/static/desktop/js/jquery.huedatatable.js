          ...
          if (endRow != $t.data('endRow') || (endRow == $t.data('endRow') && endCol > $t.data('endCol')) || force) {
            ...
            if ($t.data('fnDraws') === 0) {
              ...
              for (var i = 0; i < data.length; i++) {
                html += '<tr class="ht-visible-row ht-visible-row-' + i + '" style="height: 32px"><td ' + (i === 0 ? 'class="ht-fixed-col"' : '') + ' >' + data[i][0] + '</td><td colspan="' + (aoColumns.length - 1) + '" class="stripe"></td></tr>';
              }
              ...
              if (force) {
                ...
                for (var i = $t.find('.ht-visible-row').length; i < data.length; i++) {
                  html += '<tr class="ht-visible-row ht-visible-row-' + i + '"><td ' + (i === 0 ? ' class="ht-fixed-col"' : '') + ' >' + data[i][0] + '</td><td colspan="' + (aoColumns.length - 1) + '" class="stripe"></td></tr>';
                }
              ...
              if (i >= startRow && i <= endRow) {
                ...
                if (row) {
                  for (var j = 0; j < endCol; j++) {
                    html += '<td ' + (!aoColumns[j].bVisible ? 'style="display: none"' : '') + (j === 0 ? ' class="ht-fixed-col"' : '') + '>' + row[j] + '</td>';
                  }
                ...
                html = '<td ' + (i === 0 ? ' class="ht-fixed-col"' : '') + '>' + data[i][0] + '</td><td colspan="' + (aoColumns.length - 1) + '" class="stripe"></td>';
              }
