...
(function () {
  ...
  var createDefaultField = function () {
    var defaultField = ko.mapping.fromJS({"name": "new_field", "type": "string", "unique": false, "keep": true, "operations": [], "required": false, "multiValued": false, "showProperties": false, "nested": [], "level": 0, "length": 100, "keyType": "string", "isPartition": false, "partitionValue": "", "comment": "", "scale": 0, "precision": 10});
  ...
  var Destination = function (vm, wizard) {
    ...
    var isTransactionalVisibleImpala = 'False'.toLowerCase() == 'true';
    var isTransactionalVisibleHive = 'True'.toLowerCase() == 'true';
    var transactionalDefaultType = 'None'.toLowerCase();
    ...
    self.indexerJobLibPath = ko.observable('/tmp/smart_indexer_lib');
  ...
  var CreateWizard = function (vm) {
    ...
    self.operationTypes = [{"name": "split", "args": [{"name": "splitChar", "type": "text", "description": "Split Chararacter"}], "outputType": "custom_fields"}, {"name": "grok", "args": [{"name": "regexp", "type": "text", "description": "Regular Expression"}], "outputType": "custom_fields"}, {"name": "convert_date", "args": [{"name": "format", "type": "text", "description": "Date Format (eg: yyyy/MM/dd)"}], "outputType": "inplace"}, {"name": "extract_uri_components", "args": [{"name": "authority", "type": "checkbox", "description": "Authority"}, {"name": "fragment", "type": "checkbox", "description": "Fragment"}, {"name": "host", "type": "checkbox", "description": "Host"}, {"name": "path", "type": "checkbox", "description": "Path"}, {"name": "port", "type": "checkbox", "description": "Port"}, {"name": "query", "type": "checkbox", "description": "Query"}, {"name": "scheme", "type": "checkbox", "description": "Scheme"}, {"name": "scheme_specific_path", "type": "checkbox", "description": "Scheme Specific Path"}, {"name": "user_info", "type": "checkbox", "description": "User Info"}], "outputType": "checkbox_fields"}, {"name": "geo_ip", "args": [{"name": "/country/iso_code", "type": "checkbox", "description": "ISO Code"}, {"name": "/country/names/en", "type": "checkbox", "description": "Country Name"}, {"name": "/subdivisions[]/names/en", "type": "checkbox", "description": "Subdivisions Names"}, {"name": "/subdivisions[]/iso_code", "type": "checkbox", "description": "Subdivisons ISO Code"}, {"name": "/city/names/en", "type": "checkbox", "description": "City Name"}, {"name": "/postal/code", "type": "checkbox", "description": "Postal Code"}, {"name": "/location/latitude", "type": "checkbox", "description": "Latitude"}, {"name": "/location/longitude", "type": "checkbox", "description": "Longitude"}], "outputType": "checkbox_fields"}, {"name": "translate", "args": [{"name": "default", "type": "text", "description": "Default Value (if no match found)"}, {"name": "mapping", "type": "mapping", "description": "Mapping"}], "outputType": "inplace"}, {"name": "find_replace", "args": [{"name": "find", "type": "text", "description": "Find"}, {"name": "replace", "type": "text", "description": "Replace"}], "outputType": "inplace"}];

    self.fieldTypes = {"solr": ["text_general", "string", "double", "long", "date", "boolean"], "hive": ["string", "tinyint", "smallint", "int", "bigint", "boolean", "float", "double", "decimal", "timestamp", "date", "char", "varchar", "array", "map", "struct"], "hivePrimitive": ["string", "tinyint", "smallint", "int", "bigint", "boolean", "float", "double", "decimal", "timestamp", "date", "char", "varchar"]}.solr;
    self.hivePrimitiveFieldTypes = {"solr": ["text_general", "string", "double", "long", "date", "boolean"], "hive": ["string", "tinyint", "smallint", "int", "bigint", "boolean", "float", "double", "decimal", "timestamp", "date", "char", "varchar", "array", "map", "struct"], "hivePrimitive": ["string", "tinyint", "smallint", "int", "bigint", "boolean", "float", "double", "decimal", "timestamp", "date", "char", "varchar"]}.hivePrimitive;
    self.hiveFieldTypes = {"solr": ["text_general", "string", "double", "long", "date", "boolean"], "hive": ["string", "tinyint", "smallint", "int", "bigint", "boolean", "float", "double", "decimal", "timestamp", "date", "char", "varchar", "array", "map", "struct"], "hivePrimitive": ["string", "tinyint", "smallint", "int", "bigint", "boolean", "float", "double", "decimal", "timestamp", "date", "char", "varchar"]}.hive;
    self.fileTypes = [{"name": "csv", "args": [{"name": "fieldSeparator", "type": "text-delimiter", "description": "Field Separator"}, {"name": "recordSeparator", "type": "text-delimiter", "description": "Record Separator"}, {"name": "quoteChar", "type": "text-delimiter", "description": "Quote Character"}, {"name": "hasHeader", "type": "checkbox", "description": "Has Header"}], "description": "CSV File", "isCustomizable": true}, {"name": "json", "args": [{"name": "hasHeader", "type": "checkbox", "description": "Has Header"}], "description": "Json", "isCustomizable": true}, {"name": "excel", "args": [{"name": "hasHeader", "type": "checkbox", "description": "Has Header"}], "description": "Excel File", "isCustomizable": true}, {"name": "combined_apache", "args": [], "description": "Combined Apache Log File", "isCustomizable": false}, {"name": "syslog", "args": [], "description": "Syslog", "isCustomizable": false}, {"name": "hue", "args": [], "description": "Hue Log File", "isCustomizable": false}];
    self.prefill = ko.mapping.fromJS({"source_type": "", "target_type": "", "target_path": ""});
  ...
  var loadDefaultField = function (options) {
    ...
    return loadField($.extend({}, {"name": "new_field", "type": "string", "unique": false, "keep": true, "operations": [], "required": false, "multiValued": false, "showProperties": false, "nested": [], "level": 0, "length": 100, "keyType": "string", "isPartition": false, "partitionValue": "", "comment": "", "scale": 0, "precision": 10}, options));
  };
  ...
  var IndexerViewModel = function () {
    ...
    self.sourceType = hueUtils.getParameter('sourceType', true) || 'hive';
