      ...
      it('should report locations for "SELECT * FROM testTable t1 ORDER BY t1.a ASC, t1.b, t1.c DESC, t1.d;\nSELECT t1.bla FROM testTable2 t1;\\nSELECT * FROM testTable3 t3, testTable4 t4; |"', function () {
        assertLocations({
          ...
          expectedLocations: [
            ...
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 40, last_column: 41 }, identifierChain: [{ name: 'a' }], tables: [{ identifierChain: [{ name: 'testTable' }], alias: 't1' }], qualified: true },
            { type: 'table', location: { first_line: 1, last_line: 1, first_column: 47, last_column: 49 }, identifierChain: [{ name: 'testTable' }]},
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 50, last_column: 51 }, identifierChain: [{ name: 'b' }], tables: [{ identifierChain: [{ name: 'testTable' }], alias: 't1' }], qualified: true },
            { type: 'table', location: { first_line: 1, last_line: 1, first_column: 53, last_column: 55 }, identifierChain: [{ name: 'testTable' }]},
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 56, last_column: 57 }, identifierChain: [{ name: 'c' }], tables: [{ identifierChain: [{ name: 'testTable' }], alias: 't1' }], qualified: true },
            { type: 'table', location: { first_line: 1, last_line: 1, first_column: 64, last_column: 66 }, identifierChain: [{ name: 'testTable' }]},
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 67, last_column: 68 }, identifierChain: [{ name: 'd' }], tables: [{ identifierChain: [{ name: 'testTable' }], alias: 't1' }], qualified: true },
            ...
            { type: 'column', location: { first_line: 2, last_line: 2, first_column: 11, last_column: 14 }, identifierChain: [{ name: 'bla' }], tables: [{ identifierChain: [{ name: 'testTable2' }], alias: 't1' }], qualified: true },
            { type: 'table', location: { first_line: 2, last_line: 2, first_column: 20, last_column: 30 }, identifierChain: [{ name: 'testTable2' }]},
            { type: 'alias', source: 'table', alias: 't1', location: { first_line: 2, last_line: 2, first_column: 31, last_column: 33 }, identifierChain: [{ name: 'testTable2' }] },
            ...
            { type: 'alias', source: 'table', alias: 't4', location: { first_line: 3, last_line: 3, first_column: 41, last_column: 43 }, identifierChain: [{ name: 'testTable4' }] },
      ...
      it('should report locations for "SELECT t1.foo FROM table1 t1 CROSS JOIN table2 LEFT OUTER JOIN table3 JOIN table4 t4 ON (t1.c1 = table2.c2); |"', function() {
        assertLocations({
          ...
          expectedLocations: [
            ...
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 11, last_column: 14 }, identifierChain: [{ name: 'foo' }], tables: [{ identifierChain: [{ name: 'table1' }], alias: 't1' }], qualified: true },
            { type: 'table', location: { first_line: 1, last_line: 1, first_column: 20, last_column: 26 }, identifierChain: [{ name: 'table1' }]},
            { type: 'alias', source: 'table', alias: 't1', location: { first_line: 1, last_line: 1, first_column: 27, last_column: 29 }, identifierChain: [{ name: 'table1' }] },
            ...
            { type: 'alias', source: 'table', alias: 't4', location: { first_line: 1, last_line: 1, first_column: 83, last_column: 85 }, identifierChain: [{ name: 'table4' }] },
            { type: 'table', location: { first_line: 1, last_line: 1, first_column: 90, last_column: 92 }, identifierChain: [{ name: 'table1' }]},
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 93, last_column: 95 }, identifierChain: [{ name: 'c1' }], tables: [{ identifierChain: [{ name: 'table1' }], alias: 't1' }], qualified: true },
            { type: 'table', location: { first_line: 1, last_line: 1, first_column: 98, last_column: 104 }, identifierChain: [{ name: 'table2' }]},
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 105, last_column: 107 }, identifierChain: [{ name: 'c2' }], tables: [{ identifierChain: [{ name: 'table2' }] }], qualified: true },
      ...
      it('should report locations for "SELECT * FROM foo WHERE bar IN (SELECT * FROM bla);|"', function() {
        assertLocations({
          ...
          expectedLocations: [
            ...
            { type: 'limitClause', subquery: true, missing: true, location: { first_line: 1, last_line: 1, first_column: 50, last_column: 50 }},
      ...
      it('should report locations for "SELECT   a.|    FROM    testTableA"', function() {
        assertLocations({
          ...
          expectedLocations: [
            ...
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 10, last_column: 11 }, identifierChain: [{ name: 'a' }], tables: [{ identifierChain: [{ name: 'testTableA' }] }], qualified: false },
      ...
      it('should report locations for "SELECT foo.aaaaa|bbbb FROM testTableA"', function() {
        assertLocations({
          ...
          expectedLocations: [
            ...
            { type: 'selectList', missing: false, location: { first_line: 1, last_line: 1, first_column: 8, last_column: 13 } },
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 8, last_column: 11}, identifierChain: [{ name: 'foo' }], tables: [{ identifierChain: [{ name: 'testTableA' }] }], qualified: false },
      ...
      it('should report locations for "SELECT b, foo.aaaaa|bbbb FROM testTableA"', function() {
        assertLocations({
          ...
          expectedLocations: [
            ...
            { type: 'selectList', missing: false, location: { first_line: 1, last_line: 1, first_column: 8, last_column: 16 } },
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 8, last_column: 9}, identifierChain: [{ name: 'b' }], tables: [{ identifierChain: [{ name: 'testTableA' }] }], qualified: false  },
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 11, last_column: 14}, identifierChain: [{ name: 'foo' }], tables: [{ identifierChain: [{ name: 'testTableA' }] }], qualified: false },
      ...
      it('should report locations for "SELECT tbl.col FROM some_tbl tbl;"', function() {
        assertLocations({
          ...
          expectedLocations: [
            ...
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 12, last_column: 15 }, identifierChain: [{ name: 'col' }], tables: [{ identifierChain: [{ name: 'some_tbl' }], alias: 'tbl' }], qualified: true },
            { type: 'table', location: { first_line: 1, last_line: 1, first_column: 21, last_column: 29 }, identifierChain: [{ name: 'some_tbl' }] },
            { type: 'alias', source: 'table', alias: 'tbl', location: { first_line: 1, last_line: 1, first_column: 30, last_column: 33 }, identifierChain: [{ name: 'some_tbl' }] },
            { type: 'whereClause', missing: true, location: { first_line: 1, last_line: 1, first_column: 33, last_column: 33 }},
            { type: 'limitClause', missing: true, location: { first_line: 1, last_line: 1, first_column: 33, last_column: 33 }}
          ]
        });
      ...
      it('should report locations for "SELECT tbl.col.cplx FROM some_tbl tbl;"', function() {
        assertLocations({
          ...
          expectedLocations: [
            ...
            { type: 'table', location: { first_line: 1, last_line: 1, first_column: 8, last_column: 11 }, identifierChain: [{ name: 'some_tbl' }] },
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 12, last_column: 15 }, identifierChain: [{ name: 'col' }], tables: [{ identifierChain: [{ name: 'some_tbl' }], alias: 'tbl' }], qualified: true },
            { type: 'complex', location: { first_line: 1, last_line: 1, first_column: 16, last_column: 20 }, identifierChain: [{ name: 'col' }, { name: 'cplx' }], tables: [{ identifierChain: [{ name: 'some_tbl' }], alias: 'tbl' }], qualified: true },
            { type: 'table', location: { first_line: 1, last_line: 1, first_column: 26, last_column: 34 }, identifierChain: [{ name: 'some_tbl' }] },
            { type: 'alias', source: 'table', alias: 'tbl', location: { first_line: 1, last_line: 1, first_column: 35, last_column: 38 }, identifierChain: [{ name: 'some_tbl' }] },
            { type: 'whereClause', missing: true, location: { first_line: 1, last_line: 1, first_column: 38, last_column: 38 }},
            { type: 'limitClause', missing: true, location: { first_line: 1, last_line: 1, first_column: 38, last_column: 38 }}
          ]
        });
      ...
      it('should report locations for "SELECT some_tbl.col.cplx FROM some_tbl;"', function() {
        assertLocations({
          ...
          expectedLocations: [
            ...
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 17, last_column: 20 }, identifierChain: [{ name: 'col' }], tables: [{ identifierChain: [{ name: 'some_tbl' }] }], qualified: true },
            { type: 'complex', location: { first_line: 1, last_line: 1, first_column: 21, last_column: 25 }, identifierChain: [{ name: 'col' }, { name: 'cplx' }], tables: [{ identifierChain: [{ name: 'some_tbl' }] }], qualified: true },
      ...
      it('should report locations for "SELECT testTableB.a, cos(1), tta.abcdefg|hijk, tta.bla, cos(1) FROM testTableA tta, testTableB;"', function() {
        assertLocations({
          ...
          expectedLocations: [
            ...
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 19, last_column: 20 }, identifierChain: [{ name: 'a' }], tables: [{ identifierChain: [{ name: 'testTableB' }] }], qualified: true },
            ...
            { type: 'column', location: { first_line: 1, last_line: 1, first_column: 51, last_column: 54 }, identifierChain: [{ name: 'bla' }], tables: [{ identifierChain: [{ name: 'testTableA' }], alias: 'tta' }], qualified: true },
            ...
            { type: 'alias', source: 'table', alias: 'tta', location: { first_line: 1, last_line: 1, first_column: 79, last_column: 82 }, identifierChain: [{ name: 'testTableA' }] },
