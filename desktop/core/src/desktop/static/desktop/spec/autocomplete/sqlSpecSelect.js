  ...
  describe('sql.js SELECT statements', function() {
    ...
    describe('Locations', function () {
      it('should suggest locations for "SELECT   |    FROM    testTableA"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTableA' }] },
      ...
      it('should suggest locations for "SELECT   a.|    FROM    testTableA"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ identifierChain: [{ name: 'a' }], table: 'testTableA' }] },
            suggestKeywords: ['*'],
            locations: [
      ...
      it('should suggest locations for "SELECT foo.aaaaa|bbbb FROM testTableA"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ identifierChain: [{ name: 'foo' }], table: 'testTableA' }] },
            suggestKeywords: ['*'],
            locations: [
      ...
      it('should handle "SELECT * FROM testTable t1 ORDER BY t1.a ASC, t1.b, t1.c DESC, t1.d;\nSELECT t1.bla FROM testTable2 t1;\\nSELECT * FROM testTable3 t3, testTable4 t4 WHERE |"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'testTable3', alias: 't3' }, { table: 'testTable4', alias: 't4' }] },
            locations: [
      ...
      it('should suggest keywords for "SELECT DISTINCT | a, b, c FROM tbl"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'tbl' }] },
            locations: [
      ...
      it('should suggest tables for "SELECT | FROM tableA;"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'tableA' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT | FROM testWHERE"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'testWHERE' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT | FROM testON"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'testON' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT | FROM transactions"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'transactions' }] }
          }
        });
      });
      ...
      it('should suggest aliases for "SELECT | FROM testTableA tta, testTableB"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'testTableA', alias: 'tta' }, { table: 'testTableB' }] }
          }
        });
      });
      ...
      it('should suggest columns for "select | from database_two.testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'testTable', database: 'database_two' }] }
          }
        });
      });
      ...
      it('should suggest columns for "select | from `database one`.`test table`"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'test table', database: 'database one' }] },
            locations: [
      ...
      it('should suggest aliases for "SELECT | FROM testTableA tta, (SELECT SUM(A*B) total FROM tta.arr) ttaSum, testTableB ttb"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'testTableA', alias: 'tta' }, { subQuery: 'ttaSum'}, { table: 'testTableB', alias: 'ttb' }] },
            subQueries: [{
              alias: 'ttaSum',
      ...
      it('should suggest tables for "SELECT | FROM ${some_variable};"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: '${some_variable}' }] }
          }
        });
      });
      ...
      it('should suggest tables for "SELECT * FROM testTable WHERE ${some_variable} + 1 = |"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestColumns: { types: ['NUMBER'], tables: [{ table: 'testTable'}] }
          }
        });
      });
    });
      ...
      it('should suggest columns and values for "SELECT COUNT(foo, bl = |,bla) FROM bar;"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestColumns: { types: ['COLREF'], tables: [{ table: 'bar' }] },
            suggestValues: true,
      ...
      it('should suggest columns for "SELECT extract(bla FROM | FROM bar;"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestColumns: { types: ['TIMESTAMP'], tables: [{ table: 'bar' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT extract(bla ,|  FROM bar;"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestColumns: { types: ['STRING'], tables: [{ table: 'bar' }] }
          }
        });
      });
        ...
        aggregateFunctions.forEach(function (aggregateFunction) {
          if (aggregateFunction.name === 'COUNT') {
            ...
            var expectedResult = {
              ...
              suggestColumns: { types: aggregateFunction.types || ['T'], tables: [{ table: 'testTable' }] }
            };
        ...
        binaryFunctions.forEach(function (binaryFunction) {
          assertAutoComplete({
            ...
            expectedResult: {
              ...
              suggestColumns: { types: ['T'], tables: [{ table: 'testTable' }] },
      ...
      it('should suggest columns for "SELECT CASE a =| WHEN c THEN d END FROM testTable"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: { types: ['COLREF'] },
            suggestColumns: { types: ['COLREF'], tables: [{ table: 'testTable' }] },
            suggestValues: true,
    ...
    describe('Hive Specific', function() {
      ...
      it('should suggest columns for "SELECT testMap[].| FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTable', identifierChain: [{ name: 'testMap', keySet: true }] }] },
            suggestKeywords: ['*']
          }
        });
      });
      ...
      it('should suggest columns for "SELECT testMap["anyKey"].fieldC.| FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTable', identifierChain: [{ name: 'testMap', keySet: true }, { name: 'fieldC' }] }] },
            suggestKeywords: ['*']
          }
        });
      });
      ...
      it('should suggest columns for "SELECT testArray[1].fieldC.| FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTable', identifierChain: [{ name: 'testArray', keySet: true }, { name: 'fieldC' }] }] },
            suggestKeywords: ['*']
          }
        });
      });
      ...
      it('should suggest columns for "SELECT testFoo[1].testBar[\"key\"].| FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTable', identifierChain: [{ name: 'testFoo', keySet: true }, { name: 'testBar', keySet: true }] }] },
            suggestKeywords: ['*']
          }
        });
      });
      ...
      describe('lateral views', function() {
        ...
        it('should suggest columns for "SELECT * FROM testTable LATERAL VIEW explode(|"', function () {
          assertAutoComplete({
            ...
            expectedResult: {
              ...
              suggestColumns: { types: ['ARRAY', 'MAP' ], tables: [{ table: 'testTable' }] }
            }
          });
        });
        ...
        it('should suggest columns for "SELECT * FROM testTable LATERAL VIEW explode(a.b.|"', function () {
          assertAutoComplete({
            ...
            expectedResult: {
              lowerCase: false,
              suggestColumns: { types: ['ARRAY', 'MAP' ], tables: [{ table: 'testTable', identifierChain: [ { name: 'a' }, { name: 'b' }] }] }
            }
          });
        });
        ...
        it('should suggest columns for "SELECT * FROM testTable LATERAL VIEW posexplode(|"', function () {
          assertAutoComplete({
            ...
            expectedResult: {
              ...
              suggestColumns: { types: ['ARRAY' ], tables: [{ table: 'testTable' }] }
            }
          });
        });
    ...
    describe('Impala Specific', function() {
      ...
      it('should suggest columns for "SELECT columnA.fieldC.| FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTable', identifierChain: [{ name: 'columnA' }, { name: 'fieldC' }] }] },
            suggestKeywords: ['*'] // TODO: Verify that this is true
          }
        });
      });
      ...
      it('should suggest columns for "SELECT tm.| FROM testTable t, t.testMap tm;"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestKeywords: ['*'],
            suggestColumns: { tables: [{ table: 'testTable', identifierChain: [{ name: 'testMap' }] }] },
            locations: [
      ...
      it('should suggest columns for "SELECT ta.* FROM testTable t, t.testArray ta WHERE ta.|"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTable', identifierChain: [{ name: 'testArray' }] }] },
            locations: [
      ...
      it('should suggest identifier for "SELECT | FROM testTable t, t.testMap tm;"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'testTable', alias: 't' }] },
      ...
      it('should suggest values for "SELECT * FROM testTable t, t.testMap tm WHERE tm.key =|"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestFunctions: { types: ['COLREF'] },
            suggestValues: true,
            suggestColumns: { types: ['COLREF'], tables: [{ table: 'testTable', alias: 't' }] },
            suggestIdentifiers : [{ name: 'tm.', type: 'alias' }],
    ...
    describe('Hive and Impala Struct Completion', function() {
      it('should suggest columns for SELECT columnA.| FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestKeywords: ['*'], // TODO: Verify that this is true
            suggestColumns: { tables: [{ table: 'testTable', identifierChain: [{ name: 'columnA' }] }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT columnA.fieldC.| FROM database_two.testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTable', database: 'database_two', identifierChain: [{ name: 'columnA' }, { name: 'fieldC' }] }] },
            suggestKeywords: ['*'] // TODO: Verify that this is true
          }
        });
      });
    ...
    describe('Value Expression Completion', function() {
      ...
      it('should suggest identifiers for "SELECT 1 = | OR false FROM tableOne boo, tableTwo baa;"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: { types: ['NUMBER'] },
            suggestColumns: { types: ['NUMBER'], tables: [{ table: 'tableOne', alias: 'boo'}, { table: 'tableTwo', alias: 'baa'}] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT * FROM tbl1, tbl2 atbl2, tbl3 WHERE id = atbl2.|"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { types: ['T'], tables: [{ table: 'tbl2' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT * FROM tbl1, tbl2 atbl2, tbl3 WHERE cos(1) = atbl2.bla.|"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { types: ['DOUBLE'], tables: [{ identifierChain: [{ name: 'bla' }], table: 'tbl2' }] }
          }
        });
      });
      ...
      it('should suggest columns for "select foo from tbl where | % 2 = 0"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: true,
            suggestFunctions: { types: ['NUMBER'] },
            suggestColumns: { types: ['NUMBER'], tables: [{ table: 'tbl' }] }
          }
        });
      });
      ...
      it('should suggest values for "SELECT * FROM testTable WHERE \'foo\' = |"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: { types: ['STRING'] },
            suggestColumns: { types: ['STRING'], tables: [{ table: 'testTable' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT cos(| FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestColumns: { types: ['DECIMAL', 'DOUBLE'], tables: [{ table: 'testTable' }] }
          }
        });
      });
      ...
      it('should suggest typed columns for "SELECT cos(| FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestColumns: { types: ['DOUBLE'], tables: [{ table: 'testTable' }] }
          }
        });
      });
      ...
      it('should suggest typed columns for "SELECT substr(\'foo\', |) FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: { types: ['INT'] },
            suggestColumns: { types: ['INT'], tables: [{ table: 'testTable' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT cast(a AS BIGINT) = | FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestColumns: { types: ['BIGINT'], tables: [{ table: 'testTable' }] }
          }
        });
      });
      ...
      it('should suggest typed columns for "SELECT CAST(18446744073709001000BD AS DECIMAL(38,0)) = | FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestColumns: { types: ['DECIMAL'], tables: [{ table: 'testTable' }] }
          }
        });
      });
      ...
      it('should suggest typed columns for "SELECT years_add(a , 10) = | FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: { types: ['TIMESTAMP'] },
            suggestColumns: { types: ['TIMESTAMP'], tables: [{ table: 'testTable' }] }
          }
        });
      });
      ...
      it('should suggest typed columns for "SELECT partial.parital| > cast(years_add(a , 10) AS INT) FROM testTable"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { types: [ 'INT' ], tables: [{ identifierChain: [{ name: 'partial' }], table: 'testTable' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT * FROM foo WHERE id LIKE |"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: { types: ['STRING'] },
            suggestColumns: { types: ['STRING'], tables: [{ table: 'foo' }] }
          }
        });
      });
      ...
      it('should suggest identifiers for "SELECT * FROM foo bla, bar WHERE id IS NULL AND |"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'foo', alias: 'bla' }, { table: 'bar' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT * FROM foo AS bla WHERE id IS NULL && |"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'foo', alias: 'bla' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT * FROM foo bar WHERE NOT |"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'foo', alias: 'bar' }] },
      ...
      it('should suggest columns for "SELECT * FROM foo bar WHERE ! |"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestColumns: { types: ['BOOLEAN'], tables: [{ table: 'foo', alias: 'bar' }] }
          }
        });
      });
    ...
    describe('Field Completion', function() {
      ...
      it('should suggest columns for "SELECT t1.testTableColumn1, t2.testTableColumn3 FROM testTable1 t1 JOIN testTable2 t2 ON t1.|"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTable1' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT b.| FROM dbOne.foo f JOIN dbOne.bar b"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestKeywords: ['*'],
            suggestColumns: { tables: [{ table: 'bar', database: 'dbOne' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT t1.testTableColumn1, t2.testTableColumn3 FROM database_two.testTable1 t1 JOIN testTable2 t2 ON t1.|"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTable1', database: 'database_two' }] }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT tta.| FROM testTableA tta, testTableB ttb"', function() {
        ...
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestKeywords: ['*'],
            suggestColumns: { tables: [{ table: 'testTableB' }] }
          }
        });
      });
    });
      ...
      it('should suggest columns for "SELECT * FROM database_two.testTable ORDER BY |"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestFunctions: {},
            suggestAnalyticFunctions: true,
            suggestColumns: { tables: [{ database: 'database_two', table: 'testTable' }] }
          }
        });
      });
      ...
      it('should suggest keywords for "SELECT * FROM database_two.testTable ORDER BY foo + |"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: { types: ['NUMBER'] },
            suggestColumns: { types: ['NUMBER'], tables: [{ database: 'database_two', table: 'testTable' }] }
          }
        });
      });
      ...
      it('should suggest identifier for "SELECT * FROM testTableA tta, testTableB GROUP BY bla+|"', function() {
        assertAutoComplete({
          ...
          expectedResult : {
            lowerCase: false,
            suggestFunctions: { types: ['NUMBER'] },
            suggestColumns: { types: ['NUMBER'], tables: [{ table: 'testTableA', alias: 'tta' }, { table: 'testTableB' }] }
          }
        });
      });
      ...
      it('should suggest tables for "SELECT testTable1.* FROM testTable1 JOIN testTable2 ON |"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'testTable1' }, { table: 'testTable2' }] }
          }
        });
      });
    ...
    it('should suggest columns for "SELECT testTable1.* FROM testTable1 JOIN testTable2 ON (testTable2.|"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestColumns: { tables: [{ table: 'testTable2'}] }
          }
        });
      });
      ...
      it('should suggest identifiers for "select * from testTable1 join db.testTable2 on |"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'testTable1' }, { table: 'testTable2', database: 'db' }] }
          }
        });
      });
      ...
      it('should suggest identifiers for "select * from testTable1 JOIN testTable2 on (testTable1.testColumn1 = |"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestColumns: { types: ['COLREF'], tables: [{ table: 'testTable1' }, { table: 'testTable2' }] }
          }
        });
      });
      ...
      it('should suggest columns for "select * from testTable1 JOIN testTable2 on (testTable1.testColumn1 = testTable2.|"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: true,
            colRef: { identifierChain: [{ name: 'testColumn1'}], table: 'testTable1' },
            suggestColumns: { types: ['COLREF'], tables: [{ table: 'testTable2'}] }
          }
        });
      });
        ...
        it('should suggest identifiers for "SELECT t1.* FROM table1 t1 CROSS JOIN table2 LEFT OUTER JOIN table3 JOIN table4 t4 ON (| AND t1.c1 = t2.c2"', function() {
          assertAutoComplete({
            ...
            expectedResult: {
              lowerCase: false,
              suggestFunctions: {},
              suggestColumns: { tables: [{ table: 'table1', alias: 't1' }, { table: 'table2' }, { table: 'table3' }, { table: 'table4', alias: 't4' }] }
            }
          });
        });
        ...
        it('should suggest identifiers for "SELECT t1.* FROM table1 t1 JOIN table2 t2 USING (foo, bar) WHERE "', function () {
          assertAutoComplete({
            ...
            expectedResult: {
              ...
              suggestFunctions: {},
              suggestKeywords: ['EXISTS', 'NOT EXISTS'],
              suggestColumns: { tables: [{ table: 'table1', alias: 't1'}, { table: 'table2', alias: 't2' }] }
            }
          });
        });
      ...
      it('should suggest keywords for "SELECT * FROM foo WHERE bar IN (|"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestFunctions: { types: ['COLREF'] },
            suggestValues: true,
            suggestColumns: { types: ['COLREF'], tables: [{ table: 'foo' }] },
            colRef: { identifierChain: [{ name: 'bar'}], table: 'foo' }
          }
        });
      });
      ...
      it('should suggest keywords for "select * from foo, bar where bar.bla in (|"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestFunctions: { types: ['COLREF'] },
            suggestValues: true,
            suggestColumns: { types: ['COLREF'], tables: [{ table: 'foo' }, { table: 'bar' }] },
            colRef: { identifierChain: [{name: 'bla'}], table: 'bar' }
          }
        });
      });
      ...
      it('should suggest columns for "SELECT "contains an even number" FROM t1, t2 AS ta2 WHERE EXISTS (SELECT t3.foo FROM t3 WHERE | % 2 = 0"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: { types: ['NUMBER'] },
            suggestColumns: { types: ['NUMBER'], tables: [{ table: 't1' }, { table: 't2', alias: 'ta2' }, { table: 't3'}] },
            locations: [
      ...
      it('should suggest identifiers for "SELECT | FROM testTable tt, (SELECT bla FROM abc WHERE foo > 1) bar"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ table: 'testTable', alias: 'tt' }, { subQuery: 'bar' }] },
            locations: [
              {type: 'table', location: { first_line: 1, last_line: 1, first_column: 14, last_column: 23}, table: 'testTable'},
      ...
      it('should suggest columns for "select | from (select id i, name as n, bla from foo) bar"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ subQuery: 'bar' }] },
            subQueries: [{
              alias: 'bar',
              columns: [
      ...
      it('should suggest identifiers for "SELECT cos(| FROM (SELECT b FROM foo) boo, (SELECT a FROM bla) bar"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase: false,
            suggestFunctions: { types: ['T'] },
            suggestColumns: { types: ['T'], tables: [{ subQuery: 'boo'}, { subQuery: 'bar' }] },
            subQueries: [{
              alias: 'boo',
              columns: [{ identifierChain: [{ name: 'b' }], type: 'COLREF', table: 'foo' }]
            }, {
      ...
      it('should suggest identifiers for "SELECT | FROM (SELECT * FROM tableOne) AS subQueryOne, someDb.tableTwo tAlias, tableThree, (SELECT * FROM t3 JOIN table4 t4 ON t3.id = t4.id) subQueryTwo;"', function() {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ subQuery: 'subQueryOne'}, { table: 'tableTwo', database: 'someDb', alias: 'tAlias' }, { table: 'tableThree' }, { subQuery: 'subQueryTwo' }] },
            subQueries: [{
              alias: 'subQueryOne',
      ...
      it('should suggest columns for "SELECT | FROM (SELECT * FROM (SELECT * FROM tableOne) subQueryOne) subQueryTwo"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ subQuery: 'subQueryTwo'}] },
            subQueries: [{
              alias: 'subQueryTwo',
      ...
      it('should suggest columns for "SELECT | FROM (SELECT * FROM (SELECT * FROM (SELECT * FROM tableOne) subQueryOne) subQueryTwo) subQueryThree"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ subQuery: 'subQueryThree'}] },
            subQueries: [{
              alias: 'subQueryThree',
      ...
      it('should suggest columns for "SELECT * FROM (SELECT * FROM (SELECT | FROM (SELECT * FROM tableOne) subQueryOne) subQueryTwo) subQueryThree"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            ...
            suggestAnalyticFunctions: true,
            suggestFunctions: {},
            suggestColumns: { tables: [{ subQuery: 'subQueryOne'}] },
            subQueries: [{
              alias: 'subQueryOne',
              columns: [{ table: 'tableOne' }]
            }]
      ...
      it('should suggest columns for "SELECT s2.| FROM (SELECT a, bla FROM (SELECT a, b, abs(1) as bla FROM testTable) s1) s2;"', function () {
        assertAutoComplete({
          ...
          expectedResult: {
            lowerCase:false,
            suggestKeywords: ['*'],
            suggestColumns: { tables: [{ subQuery: 's2' }] },
            subQueries: [{
              alias: 's2',
              columns: [
