...
class ThriftTaskInProgress(object):
  ...
  def write(self, oprot):
    ...
    if self.taskStatuses != None:
      ...
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.taskDiagnosticData != None:
    ...
    if self.runningAttempts != None:
      ...
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.successfulAttempt != None:
...
class ThriftClusterStatus(object):
  ...
  def write(self, oprot):
    ...
    if self.activeTrackerNames != None:
      ...
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.blacklistedTrackerNames != None:
...
class TaskAttemptNotFoundException(Exception):
  """
...
class TaskTrackerNotFoundException(Exception):
  """
