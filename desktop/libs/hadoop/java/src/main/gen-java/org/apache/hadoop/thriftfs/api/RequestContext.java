...
public class RequestContext implements org.apache.thrift.TBase<RequestContext, RequestContext._Fields>, java.io.Serializable, Cloneable {
  ...
  private static class RequestContextStandardScheme extends StandardScheme<RequestContext> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.confOptions = new HashMap<String,String>(2*_map8.size);
                for (int _i9 = 0; _i9 < _map8.size; ++_i9)
                {
                  ...
                  struct.confOptions.put(_key10, _val11);
                }
                iprot.readMapEnd();
              }
              struct.setConfOptionsIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RequestContext struct) throws org.apache.thrift.TException {
      ...
      if (struct.confOptions != null) {
        oprot.writeFieldBegin(CONF_OPTIONS_FIELD_DESC);
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING, struct.confOptions.size()));
          for (Map.Entry<String, String> _iter12 : struct.confOptions.entrySet())
          {
  ...
  private static class RequestContextTupleScheme extends TupleScheme<RequestContext> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, RequestContext struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetConfOptions()) {
        optionals.set(0);
      }
      oprot.writeBitSet(optionals, 1);
      if (struct.isSetConfOptions()) {
        {
          oprot.writeI32(struct.confOptions.size());
          for (Map.Entry<String, String> _iter13 : struct.confOptions.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.confOptions = new HashMap<String,String>(2*_map14.size);
          for (int _i15 = 0; _i15 < _map14.size; ++_i15)
          {
            ...
            struct.confOptions.put(_key16, _val17);
          }
        }
        struct.setConfOptionsIsSet(true);
      }
