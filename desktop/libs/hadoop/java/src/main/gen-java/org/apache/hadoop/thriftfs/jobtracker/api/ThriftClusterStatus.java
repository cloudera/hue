...
public class ThriftClusterStatus implements TBase<ThriftClusterStatus, ThriftClusterStatus._Fields>, java.io.Serializable, Cloneable {
  ...
  private static final TField ACTIVE_TRACKER_NAMES_FIELD_DESC = new TField("activeTrackerNames", TType.LIST, (short)2);
  private static final TField BLACKLISTED_TRACKER_NAMES_FIELD_DESC = new TField("blacklistedTrackerNames", TType.LIST, (short)3);
  private static final TField NUM_BLACKLISTED_TRACKERS_FIELD_DESC = new TField("numBlacklistedTrackers", TType.I32, (short)4);
  private static final TField NUM_EXCLUDED_NODES_FIELD_DESC = new TField("numExcludedNodes", TType.I32, (short)5);
  private static final TField TASK_TRACKER_EXPIRY_INTERVAL_FIELD_DESC = new TField("taskTrackerExpiryInterval", TType.I64, (short)6);
  private static final TField MAP_TASKS_FIELD_DESC = new TField("mapTasks", TType.I32, (short)7);
  private static final TField REDUCE_TASKS_FIELD_DESC = new TField("reduceTasks", TType.I32, (short)8);
  private static final TField MAX_MAP_TASKS_FIELD_DESC = new TField("maxMapTasks", TType.I32, (short)9);
  private static final TField MAX_REDUCE_TASKS_FIELD_DESC = new TField("maxReduceTasks", TType.I32, (short)10);
  private static final TField STATE_FIELD_DESC = new TField("state", TType.I32, (short)11);
  private static final TField USED_MEMORY_FIELD_DESC = new TField("usedMemory", TType.I64, (short)12);
  private static final TField MAX_MEMORY_FIELD_DESC = new TField("maxMemory", TType.I64, (short)13);
  private static final TField TOTAL_SUBMISSIONS_FIELD_DESC = new TField("totalSubmissions", TType.I32, (short)14);
  private static final TField HAS_RESTARTED_FIELD_DESC = new TField("hasRestarted", TType.BOOL, (short)15);
  private static final TField HAS_RECOVERED_FIELD_DESC = new TField("hasRecovered", TType.BOOL, (short)16);
  private static final TField START_TIME_FIELD_DESC = new TField("startTime", TType.I64, (short)17);
  private static final TField HOSTNAME_FIELD_DESC = new TField("hostname", TType.STRING, (short)18);
  private static final TField IDENTIFIER_FIELD_DESC = new TField("identifier", TType.STRING, (short)19);
  private static final TField HTTP_PORT_FIELD_DESC = new TField("httpPort", TType.I32, (short)20);

  public int numActiveTrackers;
  public List<String> activeTrackerNames;
  public List<String> blacklistedTrackerNames;
  public int numBlacklistedTrackers;
  public int numExcludedNodes;
  public long taskTrackerExpiryInterval;
  public int mapTasks;
  ...
  public void unsetNumActiveTrackers() {
    __isset_bit_vector.clear(__NUMACTIVETRACKERS_ISSET_ID);
  }

  /** Returns true if field numActiveTrackers is set (has been asigned a value) and false otherwise */
  public boolean isSetNumActiveTrackers() {
    return __isset_bit_vector.get(__NUMACTIVETRACKERS_ISSET_ID);
  }

  public void setNumActiveTrackersIsSet(boolean value) {
    __isset_bit_vector.set(__NUMACTIVETRACKERS_ISSET_ID, value);
  }
  ...
  /** Returns true if field activeTrackerNames is set (has been asigned a value) and false otherwise */
  ...
  /** Returns true if field blacklistedTrackerNames is set (has been asigned a value) and false otherwise */
  ...
  public void unsetNumBlacklistedTrackers() {
    __isset_bit_vector.clear(__NUMBLACKLISTEDTRACKERS_ISSET_ID);
  }

  /** Returns true if field numBlacklistedTrackers is set (has been asigned a value) and false otherwise */
  public boolean isSetNumBlacklistedTrackers() {
    return __isset_bit_vector.get(__NUMBLACKLISTEDTRACKERS_ISSET_ID);
  }

  public void setNumBlacklistedTrackersIsSet(boolean value) {
    __isset_bit_vector.set(__NUMBLACKLISTEDTRACKERS_ISSET_ID, value);
  }
  ...
  public void unsetNumExcludedNodes() {
    __isset_bit_vector.clear(__NUMEXCLUDEDNODES_ISSET_ID);
  }

  /** Returns true if field numExcludedNodes is set (has been asigned a value) and false otherwise */
  public boolean isSetNumExcludedNodes() {
    return __isset_bit_vector.get(__NUMEXCLUDEDNODES_ISSET_ID);
  }

  public void setNumExcludedNodesIsSet(boolean value) {
    __isset_bit_vector.set(__NUMEXCLUDEDNODES_ISSET_ID, value);
  }
  ...
  public void unsetTaskTrackerExpiryInterval() {
    __isset_bit_vector.clear(__TASKTRACKEREXPIRYINTERVAL_ISSET_ID);
  }

  /** Returns true if field taskTrackerExpiryInterval is set (has been asigned a value) and false otherwise */
  public boolean isSetTaskTrackerExpiryInterval() {
    return __isset_bit_vector.get(__TASKTRACKEREXPIRYINTERVAL_ISSET_ID);
  }

  public void setTaskTrackerExpiryIntervalIsSet(boolean value) {
    __isset_bit_vector.set(__TASKTRACKEREXPIRYINTERVAL_ISSET_ID, value);
  }
  ...
  public void unsetUsedMemory() {
    __isset_bit_vector.clear(__USEDMEMORY_ISSET_ID);
  }

  /** Returns true if field usedMemory is set (has been asigned a value) and false otherwise */
  public boolean isSetUsedMemory() {
    return __isset_bit_vector.get(__USEDMEMORY_ISSET_ID);
  }

  public void setUsedMemoryIsSet(boolean value) {
    __isset_bit_vector.set(__USEDMEMORY_ISSET_ID, value);
  }
  ...
  public void unsetTotalSubmissions() {
    __isset_bit_vector.clear(__TOTALSUBMISSIONS_ISSET_ID);
  }

  /** Returns true if field totalSubmissions is set (has been asigned a value) and false otherwise */
  public boolean isSetTotalSubmissions() {
    return __isset_bit_vector.get(__TOTALSUBMISSIONS_ISSET_ID);
  }

  public void setTotalSubmissionsIsSet(boolean value) {
    __isset_bit_vector.set(__TOTALSUBMISSIONS_ISSET_ID, value);
  }
  ...
  public void unsetHasRestarted() {
    __isset_bit_vector.clear(__HASRESTARTED_ISSET_ID);
  }

  /** Returns true if field hasRestarted is set (has been asigned a value) and false otherwise */
  public boolean isSetHasRestarted() {
    return __isset_bit_vector.get(__HASRESTARTED_ISSET_ID);
  }

  public void setHasRestartedIsSet(boolean value) {
    __isset_bit_vector.set(__HASRESTARTED_ISSET_ID, value);
  }
  ...
  public void unsetHasRecovered() {
    __isset_bit_vector.clear(__HASRECOVERED_ISSET_ID);
  }

  /** Returns true if field hasRecovered is set (has been asigned a value) and false otherwise */
  public boolean isSetHasRecovered() {
    return __isset_bit_vector.get(__HASRECOVERED_ISSET_ID);
  }

  public void setHasRecoveredIsSet(boolean value) {
    __isset_bit_vector.set(__HASRECOVERED_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case NUM_ACTIVE_TRACKERS:
      return new Integer(getNumActiveTrackers());
    ...
    case NUM_BLACKLISTED_TRACKERS:
      return new Integer(getNumBlacklistedTrackers());

    case NUM_EXCLUDED_NODES:
      return new Integer(getNumExcludedNodes());

    case TASK_TRACKER_EXPIRY_INTERVAL:
      return new Long(getTaskTrackerExpiryInterval());
    ...
    case TOTAL_SUBMISSIONS:
      return new Integer(getTotalSubmissions());

    case HAS_RESTARTED:
      return new Boolean(isHasRestarted());

    case HAS_RECOVERED:
      return new Boolean(isHasRecovered());
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    oprot.writeI32(this.numActiveTrackers);
    oprot.writeFieldEnd();
    if (this.activeTrackerNames != null) {
      oprot.writeFieldBegin(ACTIVE_TRACKER_NAMES_FIELD_DESC);
      {
        oprot.writeListBegin(new TList(TType.STRING, this.activeTrackerNames.size()));
        for (String _iter57 : this.activeTrackerNames)
        {
    ...
    if (this.blacklistedTrackerNames != null) {
      ...
      {
        oprot.writeListBegin(new TList(TType.STRING, this.blacklistedTrackerNames.size()));
        for (String _iter58 : this.blacklistedTrackerNames)
        {
    ...
    oprot.writeI32(this.numBlacklistedTrackers);
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(NUM_EXCLUDED_NODES_FIELD_DESC);
    oprot.writeI32(this.numExcludedNodes);
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(TASK_TRACKER_EXPIRY_INTERVAL_FIELD_DESC);
    oprot.writeI64(this.taskTrackerExpiryInterval);
    oprot.writeFieldEnd();
    ...
    oprot.writeI32(this.totalSubmissions);
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(HAS_RESTARTED_FIELD_DESC);
    oprot.writeBool(this.hasRestarted);
    oprot.writeFieldEnd();
    oprot.writeFieldBegin(HAS_RECOVERED_FIELD_DESC);
    oprot.writeBool(this.hasRecovered);
    oprot.writeFieldEnd();
