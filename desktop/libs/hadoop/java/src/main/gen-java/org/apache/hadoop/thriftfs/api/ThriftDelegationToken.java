...
public class ThriftDelegationToken implements org.apache.thrift.TBase<ThriftDelegationToken, ThriftDelegationToken._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    schemes.put(StandardScheme.class, new ThriftDelegationTokenStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ThriftDelegationTokenTupleSchemeFactory());
  }

  public ByteBuffer delegationTokenBytes; // required
...
;
  ...
  private static class ThriftDelegationTokenStandardSchemeFactory implements SchemeFactory {
    public ThriftDelegationTokenStandardScheme getScheme() {
      return new ThriftDelegationTokenStandardScheme();
    }
  }

  private static class ThriftDelegationTokenStandardScheme extends StandardScheme<ThriftDelegationToken> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftDelegationToken struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // DELEGATION_TOKEN_BYTES
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.delegationTokenBytes = iprot.readBinary();
              struct.setDelegationTokenBytesIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftDelegationToken struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.delegationTokenBytes != null) {
        oprot.writeFieldBegin(DELEGATION_TOKEN_BYTES_FIELD_DESC);
        oprot.writeBinary(struct.delegationTokenBytes);
        oprot.writeFieldEnd();
      }
  ...
  private static class ThriftDelegationTokenTupleSchemeFactory implements SchemeFactory {
    public ThriftDelegationTokenTupleScheme getScheme() {
      return new ThriftDelegationTokenTupleScheme();
    }
  }

  private static class ThriftDelegationTokenTupleScheme extends TupleScheme<ThriftDelegationToken> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ThriftDelegationToken struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      BitSet optionals = new BitSet();
      if (struct.isSetDelegationTokenBytes()) {
        optionals.set(0);
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ThriftDelegationToken struct) throws org.apache.thrift.TException {
