 ...
 */
public class ThreadStackTrace implements TBase<ThreadStackTrace._Fields>, java.io.Serializable, Cloneable, Comparable<ThreadStackTrace> {
  ...
  public static final Map<_Fields, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new EnumMap<_Fields, FieldMetaData>(_Fields.class) {{
    ...
    put(_Fields.THREAD_STRING_REPRESENTATION, new FieldMetaData("threadStringRepresentation", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.STRING)));
    put(_Fields.IS_DAEMON, new FieldMetaData("isDaemon", TFieldRequirementType.DEFAULT, 
        new FieldValueMetaData(TType.BOOL)));
    put(_Fields.STACK_TRACE, new FieldMetaData("stackTrace", TFieldRequirementType.DEFAULT, 
  ...
  public int compareTo(ThreadStackTrace other) {
    ...
    lastComparison = Boolean.valueOf(isSetThreadStringRepresentation()).compareTo(isSetThreadStringRepresentation());
    if (lastComparison != 0) {
      return lastComparison;
    }
    lastComparison = TBaseHelper.compareTo(threadStringRepresentation, typedOther.threadStringRepresentation);
    if (lastComparison != 0) {
      return lastComparison;
    }
    lastComparison = Boolean.valueOf(isSetIsDaemon()).compareTo(isSetIsDaemon());
    if (lastComparison != 0) {
      return lastComparison;
    }
    lastComparison = TBaseHelper.compareTo(isDaemon, typedOther.isDaemon);
    if (lastComparison != 0) {
      return lastComparison;
    }
