 ...
 */
public class ThriftCounterGroup implements TBase<ThriftCounterGroup._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("ThriftCounterGroup");

  private static final TField NAME_FIELD_DESC = new TField("name", TType.STRING, (short)1);
  private static final TField DISPLAY_NAME_FIELD_DESC = new TField("displayName", TType.STRING, (short)2);
  private static final TField COUNTERS_FIELD_DESC = new TField("counters", TType.MAP, (short)3);
  ...
  public static final Map<_Fields, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new EnumMap<_Fields, FieldMetaData>(_Fields.class) {{
    ...
    put(_Fields.COUNTERS, new FieldMetaData("counters", TFieldRequirementType.DEFAULT, 
        new MapMetaData(TType.MAP, 
            new FieldValueMetaData(TType.STRING), 
            new StructMetaData(TType.STRUCT, ThriftCounter.class))));
  }});

  static {
    FieldMetaData.addStructMetaDataMap(ThriftCounterGroup.class, metaDataMap);
  }
  ...
  @Deprecated
  public ThriftCounterGroup clone() {
    return new ThriftCounterGroup(this);
  }
  ...
  public void write(TProtocol oprot) throws TException {
    ...
    if (this.counters != null) {
      ...
      {
        oprot.writeMapBegin(new TMap(TType.STRING, TType.STRUCT, this.counters.size()));
