 ...
 */
public class ThriftTaskInProgressList implements TBase<ThriftTaskInProgressList._Fields>, java.io.Serializable, Cloneable {
  ...
  public static final Map<_Fields, FieldMetaData> metaDataMap = Collections.unmodifiableMap(new EnumMap<_Fields, FieldMetaData>(_Fields.class) {{
    ...
    put(_Fields.NUM_TOTAL_TASKS, new FieldMetaData("numTotalTasks", TFieldRequirementType.DEFAULT, 
  ...
  @Deprecated
  public ThriftTaskInProgressList clone() {
    return new ThriftTaskInProgressList(this);
  }
