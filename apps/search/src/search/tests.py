...
class TestWithMockedSolr(TestSearchBase):
  ...
  def test_get_collection_fields(self):
    ...
    assert_equal(
        [{'type': 'long', 'name': '_version_'}, {'type': 'text_general', 'name': 'author'}, {'type': 'string', 'name': 'cat'}, {'type': 'text_general', 'name': 'category'}, {'type': 'text_general', 'name': 'comments'}, {'type': 'text_general', 'name': 'content'}, {'type': 'string', 'name': 'content_type'}, {'type': 'text_general', 'name': 'description'}, {'type': 'text_general', 'name': 'features'}, {'type': 'string', 'name': 'id'}, {'type': 'boolean', 'name': 'inStock'}, {'type': 'text_general', 'name': 'includes'}, {'type': 'text_general', 'name': 'keywords'}, {'type': 'date', 'name': 'last_modified'}, {'type': 'string', 'name': 'links'}, {'type': 'text_general', 'name': 'manu'}, {'type': 'string', 'name': 'manu_exact'}, {'type': 'string', 'name': 'manu_id_s'}, {'type': 'text_general', 'name': 'name'}, {'type': 'payloads', 'name': 'payloads'}, {'type': 'int', 'name': 'popularity'}, {'type': 'float', 'name': 'price'}, {'type': 'currency', 'name': 'price_c'}, {'type': 'amount_raw_type_tlong', 'name': 'price_c____amount_raw'}, {'type': 'currency_type_string', 'name': 'price_c____currency'}, {'type': 'text_general', 'name': 'resourcename'}, {'type': 'text_general', 'name': 'romain_t'}, {'type': 'text_en_splitting_tight', 'name': 'sku'}, {'type': 'location', 'name': 'store'}, {'type': 'text_general', 'name': 'subject'}, {'type': 'text_general', 'name': 'text'}, {'type': 'text_general_rev', 'name': 'text_rev'}, {'type': 'text_general', 'name': 'title'}, {'type': 'text_general', 'name': 'url'}, {'type': 'float', 'name': 'weight'}],
