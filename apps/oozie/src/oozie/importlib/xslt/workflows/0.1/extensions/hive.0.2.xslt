...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:workflow="uri:oozie:workflow:0.1" xmlns:hive="uri:oozie:hive-action:0.2" exclude-result-prefixes="workflow hive">
