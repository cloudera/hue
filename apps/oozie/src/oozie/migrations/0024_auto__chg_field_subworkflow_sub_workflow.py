...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubWorkflow.sub_workflow'
        db.alter_column('oozie_subworkflow', 'sub_workflow_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['oozie.Workflow'], null=True))

    def backwards(self, orm):

        # Changing field 'SubWorkflow.sub_workflow'
        db.alter_column('oozie_subworkflow', 'sub_workflow_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['oozie.Workflow']))
    ...
    models = {
        ...
        'oozie.bundle': {
            ...
            'kick_off_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'})
        },
        ...
        'oozie.coordinator': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 25, 0, 0)'}),
            ...
            'job_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['oozie.Job']", 'unique': 'True', 'primary_key': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 22, 0, 0)'}),
