...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:workflow="uri:oozie:workflow:0.2.5" xmlns:email="uri:oozie:email-action:0.1" exclude-result-prefixes="workflow email">
