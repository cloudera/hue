         ...
         <div class="row-fluid">
           ...
           <div class="span2">
            <ul class="nav nav-pills nav-vertical-pills">
              ...
              <li><a href="#step3" class="step">${ _('Step 3:') } <i class="fas fa-users"></i> ${ _('Users') }</a></li>
       ...
       <div class="card-body">
        <p>
          ...
          % if not user.is_authenticated():
            <br/>
            <a href="${ url('desktop_views_home2') }" class="btn btn-primary" style="margin-top: 50px;margin-bottom: 20px"><i class="fas fa-sign-in-alt"></i> ${ _('Sign in now!') }</a>
          % endif
        </p>
       </div>
      % endif
