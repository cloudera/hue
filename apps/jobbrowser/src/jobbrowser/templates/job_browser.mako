    ...
    var JobBrowserViewModel = function () {
      ...
      self.availableInterfaces = ko.pureComputed(function () {
        ...
        var livyInterfaceCondition = function () {
          ## return '${ is_mini }' == 'False' && self.appConfig() && self.appConfig()['editor'] && (self.appConfig()['editor']['interpreter_names'].indexOf('pyspark') != -1 || self.appConfig()['editor']['interpreter_names'].indexOf('sql') != -1);
          return self.appConfig() && self.appConfig()['editor'] && (self.appConfig()['editor']['interpreter_names'].indexOf('pyspark') != -1 || self.appConfig()['editor']['interpreter_names'].indexOf('sql') != -1);
        };
