...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SavedQuery.is_trashed'
        db.add_column('beeswax_savedquery', 'is_trashed', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'SavedQuery.is_trashed'
        db.delete_column('beeswax_savedquery', 'is_trashed')
