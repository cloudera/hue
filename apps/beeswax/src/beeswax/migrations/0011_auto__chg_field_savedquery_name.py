...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SavedQuery.name'
        db.alter_column(u'beeswax_savedquery', 'name', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):

        # Changing field 'SavedQuery.name'
        db.alter_column(u'beeswax_savedquery', 'name', self.gf('django.db.models.fields.CharField')(max_length=64))
