...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Session.properties'
        db.add_column(u'beeswax_session', 'properties',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Session.properties'
        db.delete_column(u'beeswax_session', 'properties')
