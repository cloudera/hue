...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QueryHistory.extra'
        db.add_column(u'beeswax_queryhistory', 'extra',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QueryHistory.extra'
        db.delete_column(u'beeswax_queryhistory', 'extra')
