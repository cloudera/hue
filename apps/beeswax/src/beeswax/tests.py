...
""")
  ...
  def test_get_sample_partitioned(self):
    ...
    """
    resp = _make_query(self.client, hql, wait=True, local=False, max=180.0, database=db_name)
    ...
    """
    resp = _make_query(self.client, hql, wait=True, local=False, max=60.0, database=db_name)
