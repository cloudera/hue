...
urlpatterns = [
  ...
  url(r'^databases/(?P<database>\w+)/metadata/(?P<cluster>.+)$', metastore_views.get_database_metadata, name='get_database_metadata'),
  ...
  url(r'^table/(?P<database>\w+)/(?P<table>\w+)/metadata/(?P<cluster>.+)$', metastore_views.get_table_metadata, name='get_table_metadata'),
