...
OOZIE_LOGS ="""  Log Type: stdout
  ...
  /etc/hadoop/conf
  /usr/lib/hadoop/hadoop-nfs-2.1.0-cdh5.1.0-SNAPSHOT.jar
  /usr/lib/hadoop/hadoop-common-2.1.0-cdh5.1.0-SNAPSHOT.jar
  /usr/lib/hadoop/hadoop-auth-2.1.0-cdh5.1.0-SNAPSHOT.jar
