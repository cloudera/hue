            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i452 in range(_size448):
                        _elem453 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
