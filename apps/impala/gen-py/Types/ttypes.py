    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.prepare_fn_symbol = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                    self.close_fn_symbol = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.update_fn_symbol = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                    self.init_fn_symbol = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRING:
                    self.serialize_fn_symbol = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                    self.merge_fn_symbol = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.STRING:
                    self.finalize_fn_symbol = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.STRING:
                    self.get_value_fn_symbol = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.STRING:
                    self.remove_fn_symbol = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.BOOL:
...
class TFunction(object):
    ...
    def validate(self):
        ...
        if self.binary_type is None:
            raise TProtocolException(message='Required field binary_type is unset!')
        if self.arg_types is None:
            raise TProtocolException(message='Required field arg_types is unset!')
        if self.ret_type is None:
            raise TProtocolException(message='Required field ret_type is unset!')
...
TAggregateFunction.thrift_spec = (
    ...
    (2, TType.STRING, 'update_fn_symbol', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'init_fn_symbol', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'serialize_fn_symbol', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'merge_fn_symbol', 'UTF8', None, ),  # 5
    (6, TType.STRING, 'finalize_fn_symbol', 'UTF8', None, ),  # 6
