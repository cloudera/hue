...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserProfile', fields ['last_activity']
        db.create_index(u'useradmin_userprofile', ['last_activity'])


    def backwards(self, orm):
        # Removing index on 'UserProfile', fields ['last_activity']
        db.delete_index(u'useradmin_userprofile', ['last_activity'])
