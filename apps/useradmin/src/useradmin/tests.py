...
class TestSAMLGroupsCheck(BaseUserAdminTests):
  def test_saml_group_conditions_check(self):
    ...
    libsaml.conf.REQUIRED_GROUPS_ATTRIBUTE.set_for_testing("groups")
    libsaml.conf.REQUIRED_GROUPS.set_for_testing(["ddd"])
    ...
    libsaml.conf.REQUIRED_GROUPS_ATTRIBUTE.set_for_testing("groups")
    libsaml.conf.REQUIRED_GROUPS.set_for_testing(["aaa","ddd"])
    ...
    libsaml.conf.REQUIRED_GROUPS_ATTRIBUTE.set_for_testing("members")
    libsaml.conf.REQUIRED_GROUPS.set_for_testing(["ddd"])
    assert_false(desktop.views.samlgroup_check(request))
